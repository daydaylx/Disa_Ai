  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // Brand Presence Animations
        "presence-idle": "presence-idle 10s ease-in-out infinite",
        "presence-typing": "presence-pulse 5s ease-in-out infinite",
        "presence-thinking": "presence-pulse 2.5s ease-in-out infinite",
        "presence-error": "presence-ping 0.8s ease-out",
      },
      keyframes: {
        fadeIn: {
          "0%": { opacity: "0" },
        ...
        "presence-ping": {
          "0%": { transform: "scaleX(1.1)", opacity: "1" },
