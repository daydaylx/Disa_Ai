...
export default [
  ...
  },
  {
    ...
    languageOptions: {
      ...
      globals: { ...globals.browser, AbortController:"readonly",AbortSignal:"readonly",ReadableStream:"readonly",TextEncoder:"readonly",crypto:"readonly" }
    },
    settings: { react:{version:"detect"},"import/resolver":{typescript:true} },
    plugins: { "@typescript-eslint": tsPlugin, react, "react-hooks": hooks, "jsx-a11y": a11y, import: imp, "unused-imports": unused, "simple-import-sort": sort },
    rules: {
      ...
      "import/first":"error","import/no-duplicates":"error","import/no-mutable-exports":"error",
      ...
      "jsx-a11y/alt-text":"warn","jsx-a11y/no-autofocus":"warn",
      "no-console":["warn",{allow:["warn","error"]}],"no-debugger":"warn"
    }
  },
  {
