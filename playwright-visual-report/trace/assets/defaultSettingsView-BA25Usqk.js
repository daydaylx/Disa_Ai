const __vite__mapDeps = (
  i,
  m = __vite__mapDeps,
  d = m.f || (m.f = ["./codeMirrorModule-CEFqZ5b3.js", "../codeMirrorModule.C3UTv-Ge.css"]),
) => i.map((i) => d[i]);
...
const Ou = {
  ...
  Ns = ({
    ...
    const [E, S] = jr(),
      [k] = $.useState(
        DS(
          () => import("./codeMirrorModule-CEFqZ5b3.js"),
          __vite__mapDeps([0, 1]),
          import.meta.url,
        ).then((R) => R.default),
      ),
...
function Lg(t) {
  ...
  if (e === void 0) {
    if (
      ...
      const n = rr(t);
      e = !n || n.display === "none" || Ag(t.getAttribute("aria-hidden")) === !0;
    }
    if (!e) {
      const n = at(t);
      n && (e = Lg(n));
