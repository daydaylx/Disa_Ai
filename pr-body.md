...
[90mCACHE_FIX_ANLEITUNG.md[39m 72ms (unchanged)
[90mCHANGELOG.md[39m 11ms (unchanged)
[90mCHAT_AUDIT_REPORT.md[39m 161ms (unchanged)
...
[90mFIX_1_IMPLEMENTATION.md[39m 66ms (unchanged)
...
[90mfunctions/api/vision.ts[39m 38ms (unchanged)
...
[90mMOBILE_UI_ON_DESKTOP.md[39m 27ms (unchanged)
...
[90mpublic/impressum.html[39m 18ms (unchanged)
...
[90mSpielerweiterung.md[39m 16ms (unchanged)
...
[90msrc/api/__tests__/visionClient.test.ts[39m 27ms (unchanged)
...
[90msrc/components/chat/ContextTray.tsx[39m 41ms (unchanged)
...
[90msrc/components/game/SurvivalQuickActions.tsx[39m 9ms (unchanged)
[90msrc/components/game/TradeModal.tsx[39m 25ms (unchanged)
...
[90msrc/components/models/ModelsCatalog.tsx[39m 52ms (unchanged)
...
[90msrc/hooks/useGameState.ts[39m 89ms (unchanged)
[90msrc/hooks/useImageAttachment.ts[39m 6ms (unchanged)
...
[90msrc/lib/imageProcessor.ts[39m 9ms (unchanged)
...
[90mtest-vision-api.js[39m 10ms (unchanged)
...
[90mVISION_ANALYSIS_REPORT.md[39m 73ms (unchanged)
...
precache  [32m66 entries[39m [2m(2658.03 KiB)[22m
files generated
