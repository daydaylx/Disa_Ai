...
Running Prettier...
npm warn config production Use `--omit=dev` instead.
[90m.changeset/config.json[39m 36ms (unchanged)
...
[90m.github/workflows/gemini-dispatch.yml[39m 23ms (unchanged)
...
[90mCLAUDE.md[39m 133ms (unchanged)
...
[90mpackage-lock.json[39m 164ms (unchanged)
...
[90msrc/pages/ChatHistoryPage.tsx[39m 23ms (unchanged)
...
[90msrc/styles/interactive-states.css[39m 21ms (unchanged)
...
[90mtests/e2e/chat.smoke.spec.ts[39m 14ms (unchanged)
