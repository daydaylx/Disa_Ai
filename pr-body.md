...
[90meslint.config.mjs[39m 316ms (unchanged)
[90mfunctions/_middleware.ts[39m 24ms (unchanged)
[90mindex-build.html[39m 50ms (unchanged)
[90mindex-correct.html[39m 22ms (unchanged)
[90mindex.html[39m 16ms (unchanged)
[90mlighthouse.config.cjs[39m 9ms (unchanged)
...
[90mpublic/sw.js[39m 33ms (unchanged)
[90mQWEN.md[39m 30ms (unchanged)
[90mREADME.md[39m 70ms (unchanged)
[90mrenovate.json[39m 5ms (unchanged)
[90mscripts/build-info.js[39m 16ms (unchanged)
[90mscripts/generate-routes.js[39m 6ms (unchanged)
...
[90msrc/__tests__/message-id-synchronization.test.ts[39m 60ms (unchanged)
[90msrc/__tests__/models-fallback.test.ts[39m 42ms (unchanged)
[90msrc/__tests__/models.cache.test.ts[39m 6ms (unchanged)
...
[90msrc/app/layouts/AppShell.tsx[39m 45ms (unchanged)
...
[90msrc/components/BuildInfo.tsx[39m 12ms (unchanged)
[90msrc/components/chat/ChatComposer.tsx[39m 29ms (unchanged)
[90msrc/components/chat/ChatHistorySidebar.tsx[39m 43ms (unchanged)
[90msrc/components/chat/ChatList.tsx[39m 30ms (unchanged)
[90msrc/components/chat/ChatMessage.tsx[39m 26ms (unchanged)
[90msrc/components/chat/ConversationHistorySheet.tsx[39m 15ms (unchanged)
[90msrc/components/chat/MessageBubbleCard.tsx[39m 10ms (unchanged)
[90msrc/components/chat/QuickstartGrid.tsx[39m 11ms (unchanged)
...
[90msrc/components/ErrorBoundary.tsx[39m 32ms (unchanged)
...
[90msrc/components/ModelPicker.tsx[39m 69ms (unchanged)
...
[90msrc/components/PWAIntegration.tsx[39m 14ms (unchanged)
...
[90msrc/components/ui/Accordion.tsx[39m 15ms (unchanged)
[90msrc/components/ui/avatar.tsx[39m 11ms (unchanged)
...
[90msrc/components/ui/card.tsx[39m 9ms (unchanged)
[90msrc/components/ui/CommandPalette.tsx[39m 37ms (unchanged)
[90msrc/components/ui/CopyButton.tsx[39m 13ms (unchanged)
[90msrc/components/ui/dialog.tsx[39m 14ms (unchanged)
[90msrc/components/ui/dropdown-menu.tsx[39m 26ms (unchanged)
...
[90msrc/components/ui/select.tsx[39m 23ms (unchanged)
...
[90msrc/data/threads.ts[39m 23ms (unchanged)
[90msrc/features/discussion/__tests__/shape.test.ts[39m 8ms (unchanged)
...
[90msrc/hooks/useMemory.ts[39m 28ms (unchanged)
...
[90msrc/lib/a11y/skipLink.ts[39m 11ms (unchanged)
...
[90msrc/lib/analytics/analytics.test.ts[39m 24ms (unchanged)
...
[90msrc/lib/configLoader.ts[39m 17ms (unchanged)
[90msrc/lib/conversation-manager.ts[39m 30ms (unchanged)
[90msrc/lib/conversation-utils.ts[39m 9ms (unchanged)
[90msrc/lib/deployment-optimizations.ts[39m 32ms (unchanged)
[90msrc/lib/errors/__tests__/mapper.test.ts[39m 17ms (unchanged)
...
[90msrc/lib/errors/types.ts[39m 16ms (unchanged)
[90msrc/lib/errorText.ts[39m 5ms (unchanged)
[90msrc/lib/formatRelativeTime.ts[39m 8ms (unchanged)
[90msrc/lib/gestures/mobileShortcuts.ts[39m 35ms (unchanged)
...
[90msrc/lib/mobile/progressive-enhancement.ts[39m 35ms (unchanged)
[90msrc/lib/model-settings.ts[39m 23ms (unchanged)
[90msrc/lib/nav.ts[39m 5ms (unchanged)
[90msrc/lib/navigation/swipeNavigation.ts[39m 28ms (unchanged)
...
[90msrc/lib/offline-storage.ts[39m 44ms (unchanged)
...
[90msrc/lib/performance/bundleOptimizer.ts[39m 33ms (unchanged)
[90msrc/lib/performance/mobileOptimizer.ts[39m 30ms (unchanged)
[90msrc/lib/performance/power-manager.ts[39m 34ms (unchanged)
[90msrc/lib/performance/webVitals.ts[39m 29ms (unchanged)
[90msrc/lib/publicAsset.ts[39m 5ms (unchanged)
[90msrc/lib/pwa-handlers.ts[39m 20ms (unchanged)
...
[90msrc/lib/sound/audio-feedback.ts[39m 23ms (unchanged)
...
[90msrc/pages/ChatV2.tsx[39m 48ms (unchanged)
[90msrc/pages/Models.tsx[39m 27ms (unchanged)
[90msrc/pages/Settings.tsx[39m 59ms (unchanged)
...
[90msrc/prompts/discussion/presets.ts[39m 5ms (unchanged)
...
[90msrc/styles/design-tokens.css[39m 9ms (unchanged)
[90msrc/styles/design-tokens.ts[39m 11ms (unchanged)
[90msrc/styles/layers.css[39m 4ms (unchanged)
[90msrc/styles/mobile-fixes.css[39m 13ms (unchanged)
[90msrc/test/setup.ts[39m 7ms (unchanged)
[90msrc/test/testServer.ts[39m 4ms (unchanged)
[90msrc/types/chat.ts[39m 3ms (unchanged)
[90msrc/types/chatMessage.ts[39m 3ms (unchanged)
...
[90msrc/ui/components/ModelPicker.tsx[39m 14ms (unchanged)
...
[90msrc/ui/ModelSheet.tsx[39m 34ms (unchanged)
...
[90msrc/ui/primitives/Tabs.tsx[39m 10ms (unchanged)
...
[90mtests/smoke/ui.smoke.test.tsx[39m 4ms (unchanged)
...
[90mui.md[39m 25ms (unchanged)
[90mUiumbau.md[39m 15ms (unchanged)
...
158 modules with unused exports
...
/home/runner/work/Disa_Ai/Disa_Ai/src/styles/design-tokens.ts: colors, SurfaceRamp, spacing, touchTargets, typography, radii, elevation, transitions, breakpoints, DesignTokens
...
transforming...
[32m✓[39m 1911 modules transformed.
rendering chunks...
[2mdist/[22m[32mindex.html                                  [39m[1m[2m  5.14 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-P6t3nRtt.css               [39m[1m[2m 71.91 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/search-tNbQDD4b.js                [39m[1m[2m  0.38 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/info-uzDTfzny.js                  [39m[1m[2m  0.41 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/badge-CkKIRXOr.js                 [39m[1m[2m  0.68 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/RoleCard-B77DL7uZ.js              [39m[1m[2m  1.68 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-DI2Jrf_k.js             [39m[1m[2m  1.74 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/Studio-DOu2ubqf.js                [39m[1m[2m  9.30 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Models-B0OjrhY5.js                [39m[1m[2m  9.35 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/conversation-manager-DVNfneAe.js  [39m[1m[2m  9.46 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Settings-CVGrMegb.js              [39m[1m[2m 29.84 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/ChatV2-BaHwQHk5.js                [39m[1m[2m 38.10 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/index-ZvGKCibo.js                 [39m[1m[2m518.94 kB[22m[1m[22m
[2m[1m16[2m[22m chunks of [2m[1m685.50 KB[2m[22m (gzip: [2m[1m239.49 KB[2m[22m | map: [2m[1m2.77 MB[2m[22m)
...
[32m✓ built in 132ms[39m

[36mPWA v1.0.3[39m
mode      [35minjectManifest[39m
format:   [35mes[39m
precache  [32m20 entries[39m [2m(1713.14 KiB)[22m
files generated
  [2mdist/sw.js[22m
