...
[90m.github/NEUES_MAIN_ANALYSIS.md[39m 18ms (unchanged)
...
[90m.qwen/PROJECT_SUMMARY.md[39m 18ms (unchanged)
.qwen/settings.json 5ms
[90magent-context.md[39m 6ms (unchanged)
[90mAUDIT_IMPACT_SUMMARY.md[39m 33ms (unchanged)
[90maudit-report.md[39m 83ms (unchanged)
[90mCATEGORY_SYSTEM.md[39m 90ms (unchanged)
[90mCONFIGURATION_NOTES.md[39m 17ms (unchanged)
[90mCRITICAL_ISSUES_SUMMARY.md[39m 21ms (unchanged)
[90mdeploy/cloudflare/cloudflare-pages.json[39m 2ms (unchanged)
[90mDEPRECATED_FILES.md[39m 24ms (unchanged)
[90mDESIGN_SYSTEM.md[39m 62ms (unchanged)
[90mDEVELOPMENT_ROADMAP.md[39m 22ms (unchanged)
[90meslint.config.mjs[39m 19ms (unchanged)
[90mEXECUTIVE_SUMMARY.md[39m 12ms (unchanged)
[90mfunctions/_middleware.ts[39m 9ms (unchanged)
[90mGLASS_PERFORMANCE_OPTIMIZATION.md[39m 41ms (unchanged)
[90mindex.html[39m 46ms (unchanged)
[90mlighthouse-report.json[39m 451ms (unchanged)
...
[90mPRIVACY.md[39m 18ms (unchanged)
...
[90mpublic/offline.html[39m 40ms (unchanged)
...
[90mRoadmap.md[39m 16ms (unchanged)
...
[90msrc/__tests__/message-id-synchronization.test.ts[39m 47ms (unchanged)
...
[90msrc/components/chat/MobileChatHistorySidebar.tsx[39m 12ms (unchanged)
...
[90msrc/components/chat/quickstartHelpers.ts[39m 4ms (unchanged)
[90msrc/components/chat/QuickstartTile.tsx[39m 9ms (unchanged)
[90msrc/components/chat/RoleSelector.tsx[39m 18ms (unchanged)
...
[90msrc/components/demo/CategoryDemo.tsx[39m 15ms (unchanged)
[90msrc/components/effects/PremiumEffects.tsx[39m 20ms (unchanged)
...
[90msrc/components/layout/MobileNavigation.tsx[39m 3ms (unchanged)
[90msrc/components/layout/MobileOnlyGate.tsx[39m 10ms (unchanged)
...
[90msrc/components/memory/MemoryPanel.tsx[39m 15ms (unchanged)
[90msrc/components/models/MobileModelsInterface.tsx[39m 44ms (unchanged)
...
[90msrc/components/studio/MobileRolesInterface.tsx[39m 34ms (unchanged)
[90msrc/components/studio/RoleCard.tsx[39m 11ms (unchanged)
[90msrc/components/Tabs.tsx[39m 4ms (unchanged)
src/components/templates/TemplateCard.tsx 8ms
[90msrc/components/ui/Accordion.tsx[39m 9ms (unchanged)
[90msrc/components/ui/avatar.tsx[39m 5ms (unchanged)
[90msrc/components/ui/badge.tsx[39m 2ms (unchanged)
[90msrc/components/ui/bottom-sheet.tsx[39m 5ms (unchanged)
[90msrc/components/ui/BottomSheet.tsx[39m 5ms (unchanged)
[90msrc/components/ui/button.tsx[39m 5ms (unchanged)
[90msrc/components/ui/card-system.md[39m 20ms (unchanged)
[90msrc/components/ui/card-types.ts[39m 14ms (unchanged)
[90msrc/components/ui/card.tsx[39m 26ms (unchanged)
[90msrc/components/ui/chip.tsx[39m 14ms (unchanged)
[90msrc/components/ui/chip/README.md[39m 37ms (unchanged)
[90msrc/components/ui/CommandPalette.tsx[39m 24ms (unchanged)
[90msrc/components/ui/CopyButton.tsx[39m 7ms (unchanged)
[90msrc/components/ui/dialog.tsx[39m 7ms (unchanged)
[90msrc/components/ui/DiscussionTopicCard.tsx[39m 12ms (unchanged)
[90msrc/components/ui/drawer-sheet.tsx[39m 11ms (unchanged)
[90msrc/components/ui/dropdown-menu.tsx[39m 15ms (unchanged)
...
[90msrc/components/ui/input.tsx[39m 6ms (unchanged)
...
[90msrc/config/personas.ts[39m 11ms (unchanged)
...
[90msrc/hooks/useDiscussion.ts[39m 9ms (unchanged)
...
[90msrc/hooks/useSwipeablePanel.ts[39m 11ms (unchanged)
...
[90msrc/lib/chat/slashCommands.ts[39m 16ms (unchanged)
...
[90msrc/lib/errorText.ts[39m 3ms (unchanged)
...
[90msrc/lib/model-settings.ts[39m 28ms (unchanged)
...
[90msrc/lib/net/online.ts[39m 3ms (unchanged)
[90msrc/lib/net/rateLimit.ts[39m 3ms (unchanged)
[90msrc/lib/net/retry.ts[39m 7ms (unchanged)
[90msrc/lib/offline-storage.ts[39m 27ms (unchanged)
...
[90msrc/lib/perf/throttle-viewport-events.ts[39m 5ms (unchanged)
...
[90msrc/pages/MobileStudio.tsx[39m 19ms (unchanged)
...
[90msrc/styles/base.css[39m 38ms (unchanged)
[90msrc/styles/bottomsheet.css[39m 6ms (unchanged)
[90msrc/styles/category-tonal-scales.css[39m 40ms (unchanged)
[90msrc/styles/chat-mobile.css[39m 24ms (unchanged)
[90msrc/styles/components.css[39m 96ms (unchanged)
[90msrc/styles/design-tokens.css[39m 66ms (unchanged)
...
[90msrc/styles/mobile-design-tokens.css[39m 61ms (unchanged)
[90msrc/styles/mobile-enhanced.css[39m 24ms (unchanged)
[90msrc/styles/mobile-utilities.css[39m 6ms (unchanged)
[90msrc/styles/theme.ts[39m 7ms (unchanged)
[90msrc/styles/tokens.css[39m 46ms (unchanged)
...
[90msrc/theme/tokens.css[39m 24ms (unchanged)
[90msrc/theme/tokens.ts[39m 19ms (unchanged)
...
[90mtests/unit/retry.test.ts[39m 6ms (unchanged)
[90mtests/unit/useChat.test.tsx[39m 9ms (unchanged)
[90mtiefenanalyse.md[39m 49ms (unchanged)
[90mTIEFENANALYSE.md[39m 31ms (unchanged)
...
156 modules with unused exports
...
transforming...
[32m✓[39m 1938 modules transformed.
rendering chunks...
[2mdist/[22m[32mindex.html                                [39m[1m[2m  6.01 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-CNWx56ny.css             [39m[1m[2m163.75 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-DlDELF1t.js           [39m[1m[2m  1.74 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/utils-BG4t5L__.js               [39m[1m[2m  1.84 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/services-Cns_BJmH.js            [39m[1m[2m  2.76 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/hooks-DTkAwPUI.js               [39m[1m[2m 17.88 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/lib-9__Gem0s.js                 [39m[1m[2m 19.61 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/feature-components-Duu4YoNm.js  [39m[1m[2m 29.25 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/index-D3Xx-0Gl.js               [39m[1m[2m 35.22 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/ui-components-CQVwUwoT.js       [39m[1m[2m 52.37 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/pages-BYLG-8Oj.js               [39m[1m[2m 69.78 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/vendor-BrQTu6m_.js              [39m[1m[2m447.74 kB[22m[1m[22m
[2m[1m12[2m[22m chunks of [2m[1m820.19 KB[2m[22m (gzip: [2m[1m270.30 KB[2m[22m | map: [2m[1m2.83 MB[2m[22m)
[32m✓ built in 6.49s[39m
...
format:   [35mes[39m
precache  [32m19 entries[39m [2m(1859.70 KiB)[22m
files generated
  [2mdist/sw.js[22m
