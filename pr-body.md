...
[90m.changeset/README.md[39m 20ms (unchanged)
...
[90mfunctions/api/chat.ts[39m 126ms (unchanged)
[90mfunctions/api/feedback.ts[39m 67ms (unchanged)
[90mGEMINI.md[39m 8ms (unchanged)
[90mindex.html[39m 150ms (unchanged)
...
[90msrc/components/chat/__tests__/UnifiedInputBar.test.tsx[39m 32ms (unchanged)
...
[90msrc/styles/theme.ts[39m 13ms (unchanged)
...
[90msrc/types/chatMessage.ts[39m 2ms (unchanged)
[90msrc/types/enhanced-interfaces.ts[39m 28ms (unchanged)
...
[90mtests/unit/lib/storage-performance-simple.test.ts[39m 30ms (unchanged)
