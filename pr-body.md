...
[90mBuch.md[39m 29ms (unchanged)
[90mbuchdesignkonzept.md[39m 23ms (unchanged)
...
[90mchatseitekonzept.md[39m 25ms (unchanged)
[90mDEPENDENCIES_UPDATE_STRATEGY.md[39m 30ms (unchanged)
[90mDEPLOY_CONFIG_GUIDE.md[39m 26ms (unchanged)
[90mdeploy/cloudflare/cloudflare-pages.json[39m 2ms (unchanged)
[90meslint.config.mjs[39m 22ms (unchanged)
[90mFINAL_IMPLEMENTATION_STATUS.md[39m 20ms (unchanged)
[90mfunctions/api/chat.ts[39m 82ms (unchanged)
[90mfunctions/api/feedback.ts[39m 22ms (unchanged)
[90mfunctions/api/models.ts[39m 21ms (unchanged)
index.html 93ms
...
[90mPR_ROLLBACK_MAIN.md[39m 7ms (unchanged)
...
[90mREADME.md[39m 82ms (unchanged)
...
[90msrc/components/BuildInfo.tsx[39m 9ms (unchanged)
[90msrc/components/chat/_legacy/ChatHistoryDrawer.tsx[39m 15ms (unchanged)
...
[90msrc/components/chat/_legacy/components/ChatHistoryItem.tsx[39m 5ms (unchanged)
[90msrc/components/chat/_legacy/components/ChatHistoryLoading.tsx[39m 1ms (unchanged)
[90msrc/components/chat/_legacy/hooks/useChatHistory.ts[39m 10ms (unchanged)
...
[90msrc/components/chat/_legacy/MobileChatComposer.tsx[39m 11ms (unchanged)
...
[90msrc/components/chat/_legacy/QuickSettingsPanel.tsx[39m 9ms (unchanged)
[90msrc/components/chat/_legacy/QuickstartGrid.tsx[39m 11ms (unchanged)
[90msrc/components/chat/_legacy/README.md[39m 6ms (unchanged)
...
[90msrc/components/chat/ChatSettingsDropup.tsx[39m 11ms (unchanged)
...
[90msrc/components/chat/UnifiedInputBar.tsx[39m 7ms (unchanged)
...
[90msrc/components/models/ModelsCatalog.tsx[39m 21ms (unchanged)
...
[90msrc/components/navigation/BookPageAnimator.tsx[39m 5ms (unchanged)
...
[90msrc/components/roles/EnhancedRolesInterface.tsx[39m 46ms (unchanged)
...
[90msrc/features/settings/TabbedSettingsView.tsx[39m 6ms (unchanged)
...
[90msrc/hooks/_legacy/useChatMemory.ts[39m 3ms (unchanged)
[90msrc/hooks/_legacy/useEdgeSwipe.ts[39m 16ms (unchanged)
[90msrc/hooks/_legacy/useMediaQuery.ts[39m 3ms (unchanged)
...
[90msrc/hooks/useFavoritesManager.ts[39m 63ms (unchanged)
...
[90msrc/lib/_legacy/font-loader.ts[39m 7ms (unchanged)
...
[90msrc/lib/_legacy/highlighting/prismTheme.ts[39m 4ms (unchanged)
[90msrc/lib/_legacy/loadScript.ts[39m 7ms (unchanged)
[90msrc/lib/_legacy/loadStylesheet.ts[39m 5ms (unchanged)
[90msrc/lib/_legacy/logging.ts[39m 1ms (unchanged)
[90msrc/lib/_legacy/README.md[39m 3ms (unchanged)
[90msrc/lib/_legacy/sw-versioning.ts[39m 7ms (unchanged)
[90msrc/lib/_legacy/useTouchGestures.ts[39m 12ms (unchanged)
[90msrc/lib/a11y/touchTargets.ts[39m 17ms (unchanged)
...
[90msrc/lib/mobile-testing-plan.md[39m 37ms (unchanged)
...
src/styles/book-enhancements.css 37ms
[90msrc/styles/DESIGN_SYSTEM.md[39m 14ms (unchanged)
...
[90msrc/styles/vertical-rhythm.css[39m 16ms (unchanged)
[90msrc/styles/white-space.css[39m 56ms (unchanged)
...
[90msrc/types/enhanced-interfaces.ts[39m 24ms (unchanged)
...
[90msrc/ui/DrawerSheet.tsx[39m 13ms (unchanged)
...
[90mSTORAGE_MIGRATION_GUIDE.md[39m 61ms (unchanged)
...
[90mtests/integration/mobile-animations.test.ts[39m 10ms (unchanged)
...
[90mtests/unit/lib/storage-layer-simple.test.ts[39m 33ms (unchanged)
...
[90mtests/unit/lib/storage-migration.test.ts[39m 41ms (unchanged)
...
[90mtools/visual-mcp.ts[39m 14ms (unchanged)
...
[90mUI_IMPROVEMENT_PLAN.md[39m 19ms (unchanged)
[90mux/Diskussionsrunden.md[39m 51ms (unchanged)
[90mux/Verschwörungstheorien-Implementierung.md[39m 36ms (unchanged)
...
/home/runner/work/Disa_Ai/Disa_Ai/src/lib/icons/index.ts: Activity, AppWindow, Circle, Code, Code2, FileText, Filter, Hash, Image, Loader2, Lock, MessageCircle, Moon, PenSquare, Pin, PinOff, Square, SunMedium, Tag, ThumbsDown, ThumbsUp, Waves, ZapOff
...
transforming...
[32m✓[39m 2627 modules transformed.
...
[39m
[2mdist/[22m[32mindex.html                                         [39m[1m[2m  9.55 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-BbxFYB72.css                      [39m[1m[2m 78.60 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/circle-check-big-DtS4ca0P.js             [39m[1m[2m  0.25 kB[22m[1m[22m[2m │ map:   0.98 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/history-C_xrkhuJ.js                      [39m[1m[2m  0.28 kB[22m[1m[22m[2m │ map:   1.03 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/zap-FkjkZNS3.js                          [39m[1m[2m  0.30 kB[22m[1m[22m[2m │ map:   0.94 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/triangle-alert-RlkLEKhr.js               [39m[1m[2m  0.32 kB[22m[1m[22m[2m │ map:   1.13 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/send-DHIQWhLD.js                         [39m[1m[2m  0.33 kB[22m[1m[22m[2m │ map:   1.04 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/Skeleton-Dxzv6qaC.js                     [39m[1m[2m  0.40 kB[22m[1m[22m[2m │ map:   1.58 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehavior-nIq5TtpU.js             [39m[1m[2m  0.50 kB[22m[1m[22m[2m │ map:   0.42 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsAppearance-CvSDSsv7.js           [39m[1m[2m  0.54 kB[22m[1m[22m[2m │ map:   0.72 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SectionHeader-DHJ57mC7.js                [39m[1m[2m  0.62 kB[22m[1m[22m[2m │ map:   1.40 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/sliders-horizontal-B_J9rv5C.js           [39m[1m[2m  0.67 kB[22m[1m[22m[2m │ map:   2.59 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/key-BWo6xR18.js                          [39m[1m[2m  1.04 kB[22m[1m[22m[2m │ map:   5.09 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/RolesPage-C9C8tPBR.js                    [39m[1m[2m  1.06 kB[22m[1m[22m[2m │ map:   1.33 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ImpressumPage-BckAEzcN.js                [39m[1m[2m  1.47 kB[22m[1m[22m[2m │ map:   2.52 kB[22m
[2mdist/[22m[2massets/[22m[36mjs