...
[90m.github/workflows/deploy.yml[39m 7ms (unchanged)
...
[90mbericht.md[39m 19ms (unchanged)
[90mCLOUDFLARE_DEPLOYMENT.md[39m 359ms (unchanged)
[90meslint.config.mjs[39m 27ms (unchanged)
[90mfunctions/_middleware.ts[39m 17ms (unchanged)
[90mICON_SETUP.md[39m 47ms (unchanged)
...
[90mpublic/offline.html[39m 47ms (unchanged)
...
[90mSERVICE_WORKER.md[39m 45ms (unchanged)
...
[90msrc/__tests__/models.cache.test.ts[39m 15ms (unchanged)
...
[90msrc/components/chat/QuickstartGrid.tsx[39m 18ms (unchanged)
[90msrc/components/chat/QuickstartTile.tsx[39m 20ms (unchanged)
[90msrc/components/chat/RoleSelector.tsx[39m 40ms (unchanged)
[90msrc/components/chat/StartTiles.tsx[39m 9ms (unchanged)
[90msrc/components/chat/TokenBadge.tsx[39m 18ms (unchanged)
[90msrc/components/chat/VirtualizedMessageList.tsx[39m 21ms (unchanged)
...
[90msrc/components/shell/NavBar.tsx[39m 13ms (unchanged)
...
[90msrc/components/ui/GlassBackdrop.tsx[39m 13ms (unchanged)
...
[90msrc/components/ui/select.tsx[39m 16ms (unchanged)
...
[90msrc/config/models.ts[39m 31ms (unchanged)
...
[90msrc/config/terminology.ts[39m 14ms (unchanged)
...
[90msrc/hooks/useMemory.ts[39m 25ms (unchanged)
...
[90msrc/lib/deployment-optimizations.ts[39m 30ms (unchanged)
...
[90msrc/lib/http.ts[39m 19ms (unchanged)
[90msrc/lib/logger.ts[39m 11ms (unchanged)
...
[90msrc/lib/offline-storage.ts[39m 42ms (unchanged)
...
[90msrc/lib/perf/throttle-viewport-events.ts[39m 21ms (unchanged)
[90msrc/lib/performance-optimizations.ts[39m 25ms (unchanged)
[90msrc/lib/performance/bundleOptimizer.ts[39m 47ms (unchanged)
[90msrc/lib/performance/mobileOptimizer.ts[39m 40ms (unchanged)
...
[90msrc/lib/pwa/offlineManager.ts[39m 34ms (unchanged)
...
[90msrc/lib/sound/audio-feedback.ts[39m 26ms (unchanged)
[90msrc/lib/storage/index.ts[39m 4ms (unchanged)
[90msrc/lib/storage/quota-manager.ts[39m 29ms (unchanged)
[90msrc/lib/storage/validators.ts[39m 9ms (unchanged)
[90msrc/lib/toast/mobileToast.ts[39m 20ms (unchanged)
[90msrc/lib/touch/__tests__/gestures.test.ts[39m 36ms (unchanged)
...
[90msrc/pages/Models.tsx[39m 54ms (unchanged)
[90msrc/pages/Settings.tsx[39m 44ms (unchanged)
[90msrc/pages/Settings/index.tsx[39m 6ms (unchanged)
[90msrc/pages/Studio.tsx[39m 22ms (unchanged)
...
[90msrc/ui/AppShell/AppShell.tsx[39m 25ms (unchanged)
...
[90msrc/ui/AppShell/Topbar.tsx[39m 9ms (unchanged)
[90msrc/ui/base.css[39m 11ms (unchanged)
...
[90msrc/ui/ModelSheet.tsx[39m 26ms (unchanged)
...
[90msrc/ui/VirtualMessageList.tsx[39m 18ms (unchanged)
...
146 modules with unused exports
...
/home/runner/work/Disa_Ai/Disa_Ai/src/config/promptStyles.ts: StyleKey
...
transforming...
[32m✓[39m 1914 modules transformed.
rendering chunks...
[2mdist/[22m[32mindex.html                            [39m[1m[2m  5.10 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-DToKk6e3.css         [39m[1m[2m588.78 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/rotate-ccw-WcG6qWFf.js      [39m[1m[2m  0.42 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Switch-CrLuQG_a.js          [39m[1m[2m  1.36 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-BnvguE6A.js       [39m[1m[2m  1.86 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/reload-manager-DZOP7DBP.js  [39m[1m[2m  2.47 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/mapper-C8Xf-p6k.js          [39m[1m[2m  3.84 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/memoryService-DqvfxxC6.js   [39m[1m[2m  4.01 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/openrouter-C6QyhoRY.js      [39m[1m[2m  5.78 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/useSettings-bCETOkpG.js     [39m[1m[2m  6.21 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/models-B5l9L_3m.js          [39m[1m[2m  6.38 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Studio-CHJXetFb.js          [39m[1m[2m  8.05 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Settings-DYCCy1IM.js        [39m[1m[2m 17.37 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Models-sFezNhqT.js          [39m[1m[2m 20.78 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/ChatV2-BzAtbBUR.js          [39m[1m[2m 51.21 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/index-C4mBTpIp.js           [39m[1m[2m513.88 kB[22m[1m[22m
[2m[1m16[2m[22m chunks of [2m[1m1.18 MB[2m[22m (gzip: [2m[1m271.42 KB[2m[22m | map: [2m[1m2.82 MB[2m[22m)
