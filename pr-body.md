...
[90mCHANGELOG.md[39m 17ms (unchanged)
...
[90mfunctions/api/chat.ts[39m 117ms (unchanged)
...
[90mPROXY_SECURITY_SUMMARY.md[39m 59ms (unchanged)
...
[90msrc/components/models/__tests__/categorizeModelFromTags.test.ts[39m 8ms (unchanged)
...
[90msrc/components/navigation/HistorySidePanel.tsx[39m 24ms (unchanged)
...
[90msrc/hooks/__tests__/useConversationManager.test.ts[39m 43ms (unchanged)
