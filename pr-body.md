...
[90mfunctions/api/chat.ts[39m 110ms (unchanged)
[90mfunctions/api/feedback.ts[39m 61ms (unchanged)
[90mGEMINI.md[39m 21ms (unchanged)
...
[90msrc/components/chat/__tests__/UnifiedInputBar.test.tsx[39m 14ms (unchanged)
...
[90mTEST_PLAN_SECURITY_PERF_DOCS.md[39m 66ms (unchanged)
...
precache  [32m75 entries[39m [2m(2368.48 KiB)[22m
files generated
