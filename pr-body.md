...
[90m.github/workflows/ci.yml[39m 22ms (unchanged)
...
[90m.github/workflows/gemini-scheduled-triage.yml[39m 5ms (unchanged)
...
[90manalysis_report.md[39m 16ms (unchanged)
[90mBuch.md[39m 27ms (unchanged)
[90mbuchdesignkonzept.md[39m 21ms (unchanged)
...
[90meslint.config.mjs[39m 19ms (unchanged)
[90mFEEDBACK_DEBUG_REPORT.md[39m 16ms (unchanged)
[90mFEEDBACK_SETUP_QUICKSTART.md[39m 13ms (unchanged)
[90mFINAL_IMPLEMENTATION_STATUS.md[39m 13ms (unchanged)
[90mfunctions/api/chat.ts[39m 35ms (unchanged)
[90mfunctions/api/feedback-resend.ts[39m 18ms (unchanged)
[90mfunctions/api/feedback.ts[39m 28ms (unchanged)
[90mindex.html[39m 138ms (unchanged)
[90mlighthouse.config.mjs[39m 6ms (unchanged)
[90mlighthouserc.cjs[39m 4ms (unchanged)
[90mMIGRATION_GUIDE.md[39m 27ms (unchanged)
...
[90mREADME.md[39m 81ms (unchanged)
...
[90msrc/__tests__/AppShellLayout.test.tsx[39m 23ms (unchanged)
...
[90msrc/api/openrouter.ts[39m 22ms (unchanged)
...
[90msrc/components/chat/_legacy/QuickSettingsPanel.tsx[39m 7ms (unchanged)
...
[90msrc/components/chat/ChatSettingsDropup.tsx[39m 13ms (unchanged)
...
[90msrc/components/navigation/ReadingProgress.tsx[39m 7ms (unchanged)
...
[90msrc/config/modelPresets.ts[39m 4ms (unchanged)
...
src/features/settings/SettingsYouthFilterView.tsx 8ms
src/features/settings/TabbedSettingsView.tsx 7ms
...
[90msrc/hooks/useFavoritesManager.ts[39m 35ms (unchanged)
...
[90msrc/lib/mobile-testing-plan.md[39m 29ms (unchanged)
...
[90msrc/lib/storage-migration.ts[39m 16ms (unchanged)
...
src/pages/ChatHistoryPage.tsx 6ms
[90msrc/pages/DatenschutzPage.tsx[39m 5ms (unchanged)
[90msrc/pages/FeedbackPage.tsx[39m 15ms (unchanged)
...
[90msrc/styles/book-enhancements.css[39m 43ms (unchanged)
[90msrc/styles/chalkboard-theme.css[39m 27ms (unchanged)
src/styles/DESIGN_SYSTEM.md 36ms
...
[90msrc/styles/tokens/color.ts[39m 10ms (unchanged)
...
[90msrc/styles/white-space.css[39m 48ms (unchanged)
...
[90mtests/e2e/models-roles.spec.ts[39m 8ms (unchanged)
...
[90mtests/unit/lib/storage-layer-simple.test.ts[39m 30ms (unchanged)
...
[90mtests/unit/lib/storage-migration.test.ts[39m 47ms (unchanged)
...
[90mUI_IMPROVEMENT_PLAN.md[39m 15ms (unchanged)
[90mux/Diskussionsrunden.md[39m 50ms (unchanged)
[90mux/Verschwörungstheorien-Implementierung.md[39m 35ms (unchanged)
...
[2mdist/[22m[2massets/[22m[35mcss/index-BEAvUlje.css                      [39m[1m[2m 78.65 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/rotate-ccw-B5EL_iLE.js                   [39m[1m[2m  0.25 kB[22m[1m[22m[2m │ map:   0.95 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/database-D8MHpICQ.js                     [39m[1m[2m  0.29 kB[22m[1m[22m[2m │ map:   1.09 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/triangle-alert-Cw_BVn1X.js               [39m[1m[2m  0.32 kB[22m[1m[22m[2m │ map:   1.13 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/trash-2-Dl7KLVBs.js                      [39m[1m[2m  0.37 kB[22m[1m[22m[2m │ map:   1.25 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehavior-Cv5c5FOx.js             [39m[1m[2m  0.50 kB[22m[1m[22m[2m │ map:   0.42 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/send-DHiWT6lu.js                         [39m[1m[2m  0.51 kB[22m[1m[22m[2m │ map:   1.99 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/palette-Bt4dEw5l.js                      [39m[1m[2m  0.56 kB[22m[1m[22m[2m │ map:   1.63 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsAppearance-CW-s8zhf.js           [39m[1m[2m  0.56 kB[22m[1m[22m[2m │ map:   0.78 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SearchInput-CEUh3uLz.js                  [39m[1m[2m  1.19 kB[22m[1m[22m[2m │ map:   3.53 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/useMemory-DZ9Bdap8.js                    [39m[1m[2m  1.50 kB[22m[1m[22m[2m │ map:   5.22 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/PageComponents-BWwUYBM8.js               [39m[1m[2m  1.82 kB[22m[1m[22m[2m │ map:   4.37 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ImpressumPage--Y0vAs8e.js                [39m[1m[2m  1.91 kB[22m[1m[22m[2m │ map:   3.07 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/presets-BGfX9iZH.js                      [39m[1m[2m  2.08 kB[22m[1m[22m[2m │ map:   4.65 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-BXVMW0uL.js                    [39m[1m[2m  2.61 kB[22m[1m[22m[2m │ map:  11.52 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsOverviewPage-zh7mepLg.js         [39m[1m[2m  2.71 kB[22m[1m[22m[2m │ map:   6.81 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsExtras-vqTA_61r.js               [39m[1m[2m  2.85 kB[22m[1m[22m[2m │ map:   5.62 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/index-C2cTX2x9.js                        [39m[1m[2m  2.93 kB[22m[1m[22m[2m │ map:   1.47 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ThemenPage-DENj-Ce6.js                   [39m[1m[2m  3.16 kB[22m[1m[22m[2m │ map:   7.22 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsLayout-Q0KcWBVJ.js               [39m[1m[2m  3.39 kB[22m[1m[22m[2m │ map:  10.16 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ChatHistoryPage-BEqu-o0_.js              [39m[1m[2m  3.51 kB[22m[1m[22m[2m │ map:   8.18 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsYouthFilter-qj-GlPtA.js          [39m[1m[2m  3.82 kB[22m[1m[22m[2m │ map:   9.10 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/FeatureFlagPanel-G_Dg8Amh.js             [39m[1m[2m  4.39 kB[22m[1m[22m[2m │ map:  15.69 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/DatenschutzPage-CGnoMHvk.js              [39m[1m[2m  4.53 kB[22m[1m[22m[2m │ map:   7.72 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ModelsPage-DlBP4_Ls.js                   [39m[1m[2m  5.41 kB[22m[1m[22m[2m │ map:  16.37 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/FeedbackPage-BnUQ-_j4.js                 [39m[1m[2m  5.73 kB[22m[1m[22m[2m │ map:  14.83 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsMemory-Coix5Zt4.js               [39m[1m[2m  6.53 kB[22m[1m[22m[2m │ map:  17.07 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/use-storage-Cwqqy3sI.js                  [39m[1m[2m  8.25 kB[22m[1m[22m[2m │ map:  36.19 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/quickstarts-BlWWbLFQ.js                  [39m[1m[2m  8.53 kB[22m[1m[22m[2m │ map:  17.42 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/RolesPage-DVdUO10C.js                    [39m[1m[2m  9.87 kB[22m[1m[22m[2m │ map:  42.27 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehaviorView-Dde_kRxu.js         [39m[1m[2m 12.39 kB[22m[1m[22m[2m │ map:  35.87 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsApiData-BjbFdjtW.js              [39m[1m[2m 21.44 kB[22m[1m[22m[2m │ map:  62.07 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/utils-vendor-BAeEp5cw.js                 [39m[1m[2m 26.37 kB[22m[1m[22m[2m │ map: 144.60 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/Chat-D6Xe-3-a.js                         [39m[1m[2m 46.81 kB[22m[1m[22m[2m │ map: 160.67 kB[22m
...
[2mdist/[22m[2massets/[22m[36mjs/main-duz4l09S.js                         [39m[1m[2m177.29 kB[22m[1m[22m[2m │ map: 762.61 kB[22m
[2m[1m42[2m[22m chunks of [2m[1m845.22 KB[2m[22m (gzip: [2m[1m306.65 KB[2m[22m | map: [2m[1m2.83 MB[2m[22m)
[32m✓ built in 7.61s[39m

[36mPWA v1.1.0[39m
mode      [35mgenerateSW[39m
precache  [32m63 entries[39m [2m(2043.87 KiB)[22m
files generated
