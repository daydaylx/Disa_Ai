...
/home/runner/work/Disa_Ai/Disa_Ai/src/components/chat/ChatHeroCore3D.tsx
  17:10  warning  'InfoChip' is defined but never used. Allowed unused vars must match /^_/u         unused-imports/no-unused-vars
  74:3   warning  'modelName' is defined but never used. Allowed unused args must match /^_/u        unused-imports/no-unused-vars
  75:3   warning  'toneLabel' is defined but never used. Allowed unused args must match /^_/u        unused-imports/no-unused-vars
  76:3   warning  'creativityLabel' is defined but never used. Allowed unused args must match /^_/u  unused-imports/no-unused-vars
  79:9   warning  'meta' is assigned a value but never used. Allowed unused vars must match /^_/u    unused-imports/no-unused-vars
...
[90m.changeset/README.md[39m 66ms (unchanged)
...
[90m.github/ISSUE_TEMPLATE/feature_request.yml[39m 34ms (unchanged)
[90m.github/pull_request_template.md[39m 21ms (unchanged)
[90m.github/REQUIRED_CHECKS.md[39m 14ms (unchanged)
...
[90m.github/workflows/code-quality.yml[39m 35ms (unchanged)
...
[90m.github/workflows/gemini-dispatch.yml[39m 28ms (unchanged)
...
[90mCACHE_FIX_ANLEITUNG.md[39m 58ms (unchanged)
...
[90mfunctions/api/chat.ts[39m 50ms (unchanged)
[90mfunctions/api/feedback.ts[39m 42ms (unchanged)
[90mGEMINI.md[39m 13ms (unchanged)
[90mindex.html[39m 198ms (unchanged)
...
[90mplaywright.config.ts[39m 25ms (unchanged)
...
[90mpublic/eye-textures/README.md[39m 12ms (unchanged)
[90mpublic/impressum.html[39m 21ms (unchanged)
...
[90mscripts/production-ready.js[39m 29ms (unchanged)
...
[90msrc/__tests__/AppShellLayout.test.tsx[39m 22ms (unchanged)
...
[90msrc/__tests__/message-id-synchronization.test.ts[39m 36ms (unchanged)
[90msrc/__tests__/modelDefaults.test.ts[39m 6ms (unchanged)
...
[90msrc/components/chat/__tests__/AnimatedCoreBackground.test.tsx[39m 4ms (unchanged)
[90msrc/components/chat/__tests__/ChatMessage.test.tsx[39m 37ms (unchanged)
[90msrc/components/chat/__tests__/ChatSettingsDropup.test.tsx[39m 42ms (unchanged)
[90msrc/components/chat/__tests__/UnifiedInputBar.test.tsx[39m 24ms (unchanged)
[90msrc/components/chat/AnimatedCoreBackground.tsx[39m 7ms (unchanged)
[90msrc/components/chat/ChatHeroBackground.tsx[39m 6ms (unchanged)
[90msrc/components/chat/ChatHeroCore3D.tsx[39m 6ms (unchanged)
[90msrc/components/chat/ChatMessage.tsx[39m 26ms (unchanged)
[90msrc/components/chat/ChatSettingsDropup.tsx[39m 18ms (unchanged)
...
[90msrc/components/chat/UnifiedInputBar.tsx[39m 14ms (unchanged)
...
[90msrc/components/eye/SimpleCssEyeOrb.tsx[39m 10ms (unchanged)
[90msrc/components/eye/types.ts[39m 1ms (unchanged)
[90msrc/components/eye/useDeviceOrientation.ts[39m 13ms (unchanged)
...
[90msrc/components/models/ModelsCatalog.tsx[39m 17ms (unchanged)
...
[90msrc/components/navigation/HistorySidePanel.tsx[39m 21ms (unchanged)
...
[90msrc/config/orbPresets.ts[39m 6ms (unchanged)
...
[90msrc/hooks/use-storage.ts[39m 30ms (unchanged)
...
[90msrc/hooks/useCoreStatus.ts[39m 2ms (unchanged)
...
[90msrc/lib/accessibility.ts[39m 26ms (unchanged)
[90msrc/lib/analytics.test.ts[39m 11ms (unchanged)
...
[90msrc/styles/animated-core.css[39m 10ms (unchanged)
[90msrc/styles/DESIGN_SYSTEM.md[39m 44ms (unchanged)
[90msrc/styles/design-tokens.ts[39m 4ms (unchanged)
src/styles/eye-orb.css 20ms
...
[90msrc/styles/ui-state-animations.css[39m 10ms (unchanged)
...
[90msrc/ui/DrawerSheet.tsx[39m 9ms (unchanged)
...
[90mtests/e2e/models-roles.spec.ts[39m 9ms (unchanged)
...
[90mtests/unit/lib/storage-migration.test.ts[39m 53ms (unchanged)
...
88 modules with unused exports
/home/runner/work/Disa_Ai/Disa_Ai/src/api/openrouter.ts: checkApiHealth, pingOpenRouter
/home/runner/work/Disa_Ai/Disa_Ai/src/components/eye/types.ts: EyeOrbPhase
/home/runner/work/Disa_Ai/Disa_Ai/src/components/eye/useDeviceOrientation.ts: DeviceOrientationPermissionState, UseDeviceOrientationResult
...
transforming...
[32m✓[39m 2642 modules transformed.
rendering chunks...
[2mdist/[22m[32mindex.html                                  [39m[1m[2m 26.45 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-C4fOSFRs.css               [39m[1m[2m117.44 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/reload-manager-DqJ_LRMs.js        [39m[1m[2m  0.25 kB[22m[1m[22m[2m │ map:     0.69 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/rotate-ccw-y3MSehzd.js            [39m[1m[2m  0.25 kB[22m[1m[22m[2m │ map:     0.95 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/database-DHB8w_re.js              [39m[1m[2m  0.29 kB[22m[1m[22m[2m │ map:     1.09 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/triangle-alert-mavMCn8z.js        [39m[1m[2m  0.32 kB[22m[1m[22m[2m │ map:     1.13 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/send-eGd-n0Wj.js                  [39m[1m[2m  0.33 kB[22m[1m[22m[2m │ map:     1.04 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/trash-2-BjyynPlW.js               [39m[1m[2m  0.37 kB[22m[1m[22m[2m │ map:     1.25 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/refresh-cw-CnMYashI.js            [39m[1m[2m  0.37 kB[22m[1m[22m[2m │ map:     1.20 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehavior-BGShNC7d.js      [39m[1m[2m  0.50 kB[22m[1m[22m[2m │ map:     0.42 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/palette-D-PhS3Uw.js               [39m[1m[2m  0.56 kB[22m[1m[22m[2m │ map:     1.63 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsAppearance-BKviq3IT.js    [39m[1m[2m  0.56 kB[22m[1m[22m[2m │ map:     0.78 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SearchInput-BydvhSfI.js           [39m[1m[2m  1.19 kB[22m[1m[22m[2m │ map:     3.53 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/useMemory-DZ9Bdap8.js             [39m[1m[2m  1.50 kB[22m[1m[22m[2m │ map:     5.22 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/PageComponents-CRgZjbcj.js        [39m[1m[2m  1.82 kB[22m[1m[22m[2m │ map:     4.37 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/presets-BZoOq681.js               [39m[1m[2m  2.08 kB[22m[1m[22m[2m │ map:     4.65 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsExtras-BkfOxLjW.js        [39m[1m[2m  2.50 kB[22m[1m[22m[2m │ map:     4.93 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-7j-WITHT.js             [39m[1m[2m  2.61 kB[22m[1m[22m[2m │ map:    11.52 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ImpressumPage-DNxhbkmH.js         [39m[1m[2m  2.65 kB[22m[1m[22m[2m │ map:     4.53 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsOverviewPage-CcrG0rbH.js  [39m[1m[2m  2.76 kB[22m[1m[22m[2m │ map:     6.87 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/index-DGFSeKYk.js                 [39m[1m[2m  2.93 kB[22m[1m[22m[2m │ map:     1.47 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsLayout-DAlSY1-c.js        [39m[1m[2m  3.41 kB[22m[1m[22m[2m │ map:    10.18 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ChatHistoryPage-DAr5xUTu.js       [39m[1m[2m  3.54 kB[22m[1m[22m[2m │ map:     8.49 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsYouthFilter-D9xKg92v.js   [39m[1m[2m  3.82 kB[22m[1m[22m[2m │ map:     9.10 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ThemenPage-CDTbGqsU.js            [39m[1m[2m  3.90 kB[22m[1m[22m[2m │ map:     9.60 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/FeatureFlagPanel-CKtlahXd.js      [39m[1m[2m  4.39 kB[22m[1m[22m[2m │ map:    15.69 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ModelsPage-BhYoyLPD.js            [39m[1m[2m  5.86 kB[22m[1m[22m[2m │ map:    17.30 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/FeedbackPage-D3Vp7GtC.js          [39m[1m[2m  5.89 kB[22m[1m[22m[2m │ map:    15.78 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsMemory-th8JTexL.js        [39m[1m[2m  6.58 kB[22m[1m[22m[2m │ map:    17.17 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/use-storage-ClsNPmsA.js           [39m[1m[2m  8.20 kB[22m[1m[22m[2m │ map:    36.19 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/quickstarts-CuX_PYUM.js           [39m[1m[2m  8.76 kB[22m[1m[22m[2m │ map:    17.70 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/RolesPage-CugVuzoa.js             [39m[1m[2m  9.85 kB[22m[1m[22m[2m │ map:    43.80 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehaviorView-DTqG5DoU.js  [39m[1m[2m 11.54 kB[22m[1m[22m[2m │ map:    34.88 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/DatenschutzPage-DNameXUh.js       [39m[1m[2m 17.31 kB[22m[1m[22m[2m │ map:    28.91 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsApiData-CzrVGyQF.js       [39m[1m[2m 21.16 kB[22m[1m[22m[2m │ map:    61.04 kB[22m
...
[2mdist/[22m[2massets/[22m[36mjs/Chat-DTYfXw_i.js                  [39m[1m[2m 51.20 kB[22m[1m[22m[2m │ map:   182.52 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/router-vendor-DLiaQ_dS.js         [39m[1m[2m 82.80 kB[22m[1m[22m[2m │ map:   522.10 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ChatHeroCore3D-R0GXat7z.js        [39m[1m[2m112.88 kB[22m[1m[22m[2m │ map:   618.81 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/react-vendor-B9D_A6Vq.js          [39m[1m[2m141.18 kB[22m[1m[22m[2m │ map:   344.91 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/main-DYmAr-yn.js                  [39m[1m[2m327.83 kB[22m[1m[22m[2m │ map: 1,259.62 kB[22m
[2m[1m42[2m[22m chunks of [2m[1m1022.36 KB[2m[22m (gzip: [2m[1m377.84 KB[2m[22m | map: [2m[1m3.50 MB[2m[22m)
[32m✓ built in 9.75s[39m

[36mPWA v1.1.0[39m
mode      [35mgenerateSW[39m
precache  [32m65 entries[39m [2m(2321.78 KiB)[22m
files generated
