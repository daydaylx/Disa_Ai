...
[90m.changeset/README.md[39m 36ms (unchanged)
...
[90m.github/workflows/_backup/ci.yml[39m 12ms (unchanged)
...
[90mbericht.md[39m 16ms (unchanged)
[90mCLOUDFLARE_DEPLOYMENT.md[39m 337ms (unchanged)
[90mcloudflare-pages.json[39m 3ms (unchanged)
[90mCRITICAL_FIXES.md[39m 59ms (unchanged)
[90meslint.config.mjs[39m 25ms (unchanged)
[90mfunctions/_middleware.ts[39m 12ms (unchanged)
[90mICON_SETUP.md[39m 39ms (unchanged)
index-build.html 28ms
index-correct.html 19ms
index.html 16ms
[90mlighthouse.config.cjs[39m 8ms (unchanged)
[90mpackage-lock.json[39m 153ms (unchanged)
...
[90mpublic/offline.html[39m 56ms (unchanged)
...
[90mpublic/sw.js[39m 51ms (unchanged)
[90mQWEN.md[39m 20ms (unchanged)
[90mREADME.md[39m 45ms (unchanged)
[90mrenovate.json[39m 4ms (unchanged)
[90mscripts/build-info.js[39m 14ms (unchanged)
[90mscripts/run-preview.mjs[39m 37ms (unchanged)
...
[90msrc/__tests__/memory.test.ts[39m 11ms (unchanged)
[90msrc/__tests__/message-id-synchronization.test.ts[39m 59ms (unchanged)
[90msrc/__tests__/models-fallback.test.ts[39m 34ms (unchanged)
[90msrc/__tests__/models.cache.test.ts[39m 10ms (unchanged)
...
[90msrc/api/openrouter.ts[39m 34ms (unchanged)
[90msrc/App.tsx[39m 12ms (unchanged)
[90msrc/app/layouts/AppShell.tsx[39m 67ms (unchanged)
...
[90msrc/components/chat/ChatList.tsx[39m 64ms (unchanged)
...
[90msrc/components/chat/QuickstartGrid.tsx[39m 19ms (unchanged)
[90msrc/components/chat/QuickstartTile.tsx[39m 20ms (unchanged)
...
[90msrc/components/CodeBlock.tsx[39m 11ms (unchanged)
[90msrc/components/Composer.tsx[39m 7ms (unchanged)
[90msrc/components/effects/PremiumEffects.tsx[39m 26ms (unchanged)
[90msrc/components/ErrorBoundary.tsx[39m 41ms (unchanged)
...
[90msrc/components/memory/MemoryPanel.tsx[39m 20ms (unchanged)
...
[90msrc/components/pwa/PWADebugInfo.tsx[39m 23ms (unchanged)
[90msrc/components/pwa/PWAInstallPrompt.tsx[39m 16ms (unchanged)
[90msrc/components/PWAIntegration.tsx[39m 9ms (unchanged)
...
[90msrc/components/studio/RoleCard.tsx[39m 15ms (unchanged)
[90msrc/components/templates/TemplateCard.tsx[39m 21ms (unchanged)
...
[90msrc/components/ui/CommandPalette.tsx[39m 31ms (unchanged)
...
[90msrc/components/ui/HolographicOrb.tsx[39m 10ms (unchanged)
...
[90msrc/components/ui/LazyImage.tsx[39m 18ms (unchanged)
...
[90msrc/components/ui/Skeleton.tsx[39m 23ms (unchanged)
[90msrc/components/ui/StaticGlassCard.tsx[39m 9ms (unchanged)
...
[90msrc/components/ui/Toast.tsx[39m 6ms (unchanged)
...
[90msrc/config/settings.ts[39m 24ms (unchanged)
...
[90msrc/data/adapter/chat.ts[39m 15ms (unchanged)
[90msrc/data/conversationTemplates.ts[39m 10ms (unchanged)
...
[90msrc/features/prompt/composeSystemPrompt.ts[39m 11ms (unchanged)
...
[90msrc/hooks/usePWAHandlers.ts[39m 17ms (unchanged)
[90msrc/hooks/usePWAInstall.ts[39m 11ms (unchanged)
[90msrc/hooks/useQuickstartFlow.ts[39m 6ms (unchanged)
[90msrc/hooks/useQuickstartManager.ts[39m 21ms (unchanged)
...
[90msrc/index.css[39m 15ms (unchanged)
...
[90msrc/lib/analytics/index.ts[39m 17ms (unchanged)
[90msrc/lib/android/system.ts[39m 24ms (unchanged)
...
[90msrc/lib/chat/sendMessage.ts[39m 11ms (unchanged)
...
[90msrc/lib/errors/__tests__/mapper.test.ts[39m 18ms (unchanged)
...
[90msrc/lib/memory/memoryService.ts[39m 24ms (unchanged)
[90msrc/lib/mobile/mobileInit.ts[39m 22ms (unchanged)
[90msrc/lib/mobile/progressive-enhancement.ts[39m 33ms (unchanged)
[90msrc/lib/model-settings.ts[39m 30ms (unchanged)
[90msrc/lib/nav.ts[39m 6ms (unchanged)
[90msrc/lib/navigation/swipeNavigation.ts[39m 31ms (unchanged)
...
[90msrc/lib/performance/mobileOptimizer.ts[39m 27ms (unchanged)
[90msrc/lib/performance/power-manager.ts[39m 22ms (unchanged)
[90msrc/lib/performance/webVitals.ts[39m 28ms (unchanged)
...
[90msrc/lib/theme/glass.ts[39m 14ms (unchanged)
[90msrc/lib/toast/mobileToast.ts[39m 23ms (unchanged)
[90msrc/lib/touch/__tests__/gestures.test.ts[39m 25ms (unchanged)
[90msrc/lib/touch/__tests__/haptics.test.ts[39m 54ms (unchanged)
[90msrc/lib/touch/gestures.ts[39m 21ms (unchanged)
[90msrc/lib/touch/haptics.ts[39m 14ms (unchanged)
[90msrc/lib/touch/performance.ts[39m 23ms (unchanged)
...
[90msrc/lib/utils/backoff.ts[39m 9ms (unchanged)
...
[90msrc/pages/Models.tsx[39m 29ms (unchanged)
[90msrc/pages/Settings.tsx[39m 66ms (unchanged)
...
[90msrc/styles/a11y-improvements.css[39m 13ms (unchanged)
...
[90msrc/ui/AppShell/AppShell.tsx[39m 19ms (unchanged)
...
[90mtests/e2e/global-setup.ts[39m 12ms (unchanged)
[90mtests/e2e/helpers/app-helpers.ts[39m 26ms (unchanged)
...
151 modules with unused exports
...
/home/runner/work/Disa_Ai/Disa_Ai/src/lib/conversation-manager.ts: ConversationExport, updateConversationTitle, searchConversations
...
transforming...
[32m✓[39m 1902 modules transformed.
rendering chunks...
[2mdist/[22m[32mindex.html                            [39m[1m[2m  5.74 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-DF7rYBY9.css         [39m[1m[2m336.42 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/ui-libs-BQCqNqg0.js         [39m[1m[2m  0.24 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-C2AUY6Nr.js       [39m[1m[2m  1.94 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/page-studio-DxoMoGYS.js     [39m[1m[2m  8.55 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/page-models-BQsP0FuY.js     [39m[1m[2m  9.84 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/chat-features-BD5AlMCD.js   [39m[1m[2m 19.39 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/ui-components-BAYMtDm-.js   [39m[1m[2m 21.32 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/utils-DtnEkxzH.js           [39m[1m[2m 25.05 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/index-Do1jVkvK.js           [39m[1m[2m 25.85 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/page-settings-D6BFe5K8.js   [39m[1m[2m 28.07 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/page-chat-DHiWxrGb.js       [39m[1m[2m 28.13 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/vendor-misc-CILpldAT.js     [39m[1m[2m 76.00 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/react-B-hV7I0p.js           [39m[1m[2m178.68 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/react-dom-CVhSNJKB.js       [39m[1m[2m184.23 kB[22m[1m[22m
[2m[1m17[2m[22m chunks of [2m[1m924.77 KB[2m[22m (gzip: [2m[1m244.65 KB[2m[22m | map: [2m[1m2.72 MB[2m[22m)
[32m✓ built in 6.87s[39m
...
rendering chunks...
computing gzip size...
[2mdist/[22m[36msw.mjs  [39m[1m[2m22.38 kB[22m[1m[22m[2m │ gzip: 7.53 kB[22m[2m │ map: 162.28 kB[22m
[32m✓ built in 143ms[39m

[36mPWA v1.0.3[39m
mode      [35minjectManifest[39m
format:   [35mes[39m
precache  [32m34 entries[39m [2m(2464.82 KiB)[22m
files generated
  [2mdist/sw.js[22m
