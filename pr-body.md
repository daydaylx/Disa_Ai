...
[90manalysis_report.md[39m 19ms (unchanged)
[90mBuch.md[39m 30ms (unchanged)
[90mbuchdesignkonzept.md[39m 29ms (unchanged)
[90mBUCHKONZEPT_UMSETZUNGSBERICHT.md[39m 56ms (unchanged)
[90mBUCHNAVIGATION_IMPLEMENTIERUNGSBERICHT.md[39m 22ms (unchanged)
[90mBUG_FIX_SUMMARY.md[39m 28ms (unchanged)
[90mchatseitekonzept.md[39m 32ms (unchanged)
[90mCLAUDE.md[39m 70ms (unchanged)
...
[90mFINAL_IMPLEMENTATION_STATUS.md[39m 19ms (unchanged)
[90mfunctions/api/chat.ts[39m 43ms (unchanged)
[90mfunctions/api/feedback.ts[39m 32ms (unchanged)
...
[90mpackage-lock.json[39m 141ms (unchanged)
...
[90mreport_completeness_20251121.md[39m 13ms (unchanged)
...
[90mscripts/production-ready.js[39m 24ms (unchanged)
...
[90msrc/components/chat/_legacy/MobileChatComposer.tsx[39m 15ms (unchanged)
[90msrc/components/chat/_legacy/MobileOptimizedChat.tsx[39m 12ms (unchanged)
[90msrc/components/chat/_legacy/ModelSelector.tsx[39m 13ms (unchanged)
[90msrc/components/chat/_legacy/QuickSettingsPanel.tsx[39m 13ms (unchanged)
[90msrc/components/chat/_legacy/QuickstartGrid.tsx[39m 21ms (unchanged)
...
[90msrc/components/chat/UnifiedInputBar.tsx[39m 11ms (unchanged)
...
[90msrc/components/layout/AppShell.tsx[39m 5ms (unchanged)
...
[90msrc/components/models/ModelsCatalog.tsx[39m 16ms (unchanged)
[90msrc/components/models/resolveInitialModelId.ts[39m 3ms (unchanged)
[90msrc/components/navigation/AchievementSystem.tsx[39m 26ms (unchanged)
...
[90msrc/components/navigation/ReadingProgress.tsx[39m 8ms (unchanged)
[90msrc/components/navigation/SwipeHandler.tsx[39m 27ms (unchanged)
...
[90msrc/config/quickstarts.ts[39m 26ms (unchanged)
...
[90msrc/data/roles.ts[39m 16ms (unchanged)
...
[90msrc/features/settings/SettingsYouthFilterView.tsx[39m 4ms (unchanged)
...
[90msrc/index.css[39m 5ms (unchanged)
...
[90msrc/pages/_legacy/SettingsFilters.tsx[39m 2ms (unchanged)
[90msrc/pages/Chat.tsx[39m 21ms (unchanged)
[90msrc/pages/ChatHistoryPage.tsx[39m 7ms (unchanged)
[90msrc/pages/DatenschutzPage.tsx[39m 6ms (unchanged)
[90msrc/pages/FeedbackPage.tsx[39m 10ms (unchanged)
...
[90msrc/pages/ThemenPage.tsx[39m 5ms (unchanged)
...
[90msrc/styles/book-enhancements.css[39m 38ms (unchanged)
[90msrc/styles/chalkboard-theme.css[39m 20ms (unchanged)
[90msrc/styles/DESIGN_SYSTEM.md[39m 15ms (unchanged)
...
[90msrc/styles/theme-ink.css[39m 18ms (unchanged)
...
[90msrc/styles/ui-state-animations.css[39m 8ms (unchanged)
[90msrc/styles/vertical-rhythm.css[39m 20ms (unchanged)
[90msrc/styles/white-space.css[39m 63ms (unchanged)
...
[90msrc/types/enhanced-interfaces.ts[39m 31ms (unchanged)
...
[90mSTORAGE_MIGRATION_GUIDE.md[39m 53ms (unchanged)
...
[90mtests/e2e/reporting/dashboard.html[39m 32ms (unchanged)
[90mtests/e2e/reporting/html-reporter.ts[39m 21ms (unchanged)
...
[90mtests/unit/lib/storage-layer-simple.test.ts[39m 52ms (unchanged)
...
[90mtests/unit/lib/storage-migration.test.ts[39m 56ms (unchanged)
...
[90mUI_IMPROVEMENT_PLAN.md[39m 11ms (unchanged)
[90mux/Diskussionsrunden.md[39m 45ms (unchanged)
[90mux/Verschwörungstheorien-Implementierung.md[39m 32ms (unchanged)
[90mux/visual-upgrade-report.md[39m 6ms (unchanged)
[90mVerschwörungstheorien.md[39m 10ms (unchanged)
...
transforming...
[32m✓[39m 2244 modules transformed.
[33mGenerated an empty chunk: "syntax-vendor".[39m
rendering chunks...
[2mdist/[22m[32mindex.html                                         [39m[1m[2m 26.45 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-BskA2BkR.css                      [39m[1m[2m 73.51 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/syntax-vendor-l0sNRNKZ.js                [39m[1m[2m  0.05 kB[22m[1m[22m[2m │ map:   0.11 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/arrow-left-BePZp07H.js                   [39m[1m[2m  0.21 kB[22m[1m[22m[2m │ map:   0.91 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/reload-manager-DqJ_LRMs.js               [39m[1m[2m  0.25 kB[22m[1m[22m[2m │ map:   0.69 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/rotate-ccw-B4866vbc.js                   [39m[1m[2m  0.25 kB[22m[1m[22m[2m │ map:   0.95 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/database-B_OG3JfT.js                     [39m[1m[2m  0.29 kB[22m[1m[22m[2m │ map:   1.09 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/triangle-alert-wObkSxI5.js               [39m[1m[2m  0.32 kB[22m[1m[22m[2m │ map:   1.13 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/trash-2-D1l6y-mi.js                      [39m[1m[2m  0.37 kB[22m[1m[22m[2m │ map:   1.25 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/send-D6ONBa25.js                         [39m[1m[2m  0.51 kB[22m[1m[22m[2m │ map:   1.99 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehavior-XNv1zLgH.js             [39m[1m[2m  0.53 kB[22m[1m[22m[2m │ map:   0.42 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/palette-BoOv7lZN.js                      [39m[1m[2m  0.56 kB[22m[1m[22m[2m │ map:   1.63 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsAppearance-CHVIh4_C.js           [39m[1m[2m  0.57 kB[22m[1m[22m[2m │ map:   0.72 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SearchInput-BQl7vqDx.js                  [39m[1m[2m  1.19 kB[22m[1m[22m[2m │ map:   3.53 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/useMemory-DZ9Bdap8.js                    [39m[1m[2m  1.50 kB[22m[1m[22m[2m │ map:   5.22 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/AppShell-4MTPwLG_.js                     [39m[1m[2m  1.57 kB[22m[1m[22m[2m │ map:   4.13 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/PageComponents-CM042yeT.js               [39m[1m[2m  1.82 kB[22m[1m[22m[2m │ map:   4.37 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/presets-Doyys0jM.js                      [39m[1m[2m  2.08 kB[22m[1m[22m[2m │ map:   4.65 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ImpressumPage-CVTEhK9g.js                [39m[1m[2m  2.32 kB[22m[1m[22m[2m │ map:   4.49 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/roleStore-CTLUWDSA.js                    [39m[1m[2m  2.61 kB[22m[1m[22m[2m │ map:  11.52 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsOverviewPage-4HwWtXus.js         [39m[1m[2m  2.75 kB[22m[1m[22m[2m │ map:   6.86 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsExtras-CRNm-2ok.js               [39m[1m[2m  2.87 kB[22m[1m[22m[2m │ map:   5.62 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/index-BoqNXSif.js                        [39m[1m[2m  2.93 kB[22m[1m[22m[2m │ map:   1.47 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsYouthFilter-BEIdzF8M.js          [39m[1m[2m  3.10 kB[22m[1m[22m[2m │ map:   6.87 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ThemenPage-BRqMY6L2.js                   [39m[1m[2m  3.16 kB[22m[1m[22m[2m │ map:   7.22 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsLayout-1fsyR-_D.js               [39m[1m[2m  3.40 kB[22m[1m[22m[2m │ map:  10.43 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ChatHistoryPage-DIgiclJl.js              [39m[1m[2m  3.93 kB[22m[1m[22m[2m │ map:   9.65 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/FeatureFlagPanel-BMq7S_pe.js             [39m[1m[2m  4.39 kB[22m[1m[22m[2m │ map:  15.69 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ModelsPage-CnKBwFw1.js                   [39m[1m[2m  4.59 kB[22m[1m[22m[2m │ map:  14.70 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/DatenschutzPage-C2_9qoma.js              [39m[1m[2m  4.98 kB[22m[1m[22m[2m │ map:   9.54 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/FeedbackPage-D4r5NFah.js                 [39m[1m[2m  6.11 kB[22m[1m[22m[2m │ map:  16.29 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsMemory-BFXXbM4U.js               [39m[1m[2m  6.55 kB[22m[1m[22m[2m │ map:  17.06 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/RolesPage-Bkx3BKV3.js                    [39m[1m[2m  8.14 kB[22m[1m[22m[2m │ map:  38.31 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/use-storage-D2j9Lq2K.js                  [39m[1m[2m  8.25 kB[22m[1m[22m[2m │ map:  36.19 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/quickstarts-BlWWbLFQ.js                  [39m[1m[2m  8.53 kB[22m[1m[22m[2m │ map:  17.42 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsBehaviorView-DgP0Q6qn.js         [39m[1m[2m 12.22 kB[22m[1m[22m[2m │ map:  35.20 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsApiData-BheTkeUm.js              [39m[1m[2m 21.46 kB[22m[1m[22m[2m │ map:  62.06 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/utils-vendor-BAeEp5cw.js                 [39m[1m[2m 26.37 kB[22m[1m[22m[2m │ map: 144.60 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/Chat-C6emOYfk.js                         [39m[1m[2m 43.03 kB[22m[1m[22m[2m │ map: 149.17 kB[22m
[2mdist/[22m[2massets/[22m[36mjs/ui-vendor-CFQ_d_OH.js                    [39m[1m[2m 70.34 kB[22m[1m[22m[2m │ map: 391.12 kB[22m
...
[2mdist/[22m[2massets/[22m[36mjs/main-b7VEiQFa.js                         [39m[1m[2m174.59 kB[22m[1m[22m[2m │ map: 755.13 kB[22m
[2m[1m44[2m[22m chunks of [2m[1m832.83 KB[2m[22m (gzip: [2m[1m304.05 KB[2m[22m | map: [2m[1m2.82 MB[2m[22m)
[32m✓ built in 7.95s[39m

[36mPWA v1.1.0[39m
mode      [35mgenerateSW[39m
precache  [32m65 entries[39m [2m(2034.52 KiB)[22m
files generated
