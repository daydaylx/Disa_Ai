...
[90mfunctions/api/vision.ts[39m 33ms (unchanged)
...
[90msrc/api/__tests__/visionClient.test.ts[39m 32ms (unchanged)
...
[90msrc/components/chat/ContextTray.tsx[39m 36ms (unchanged)
...
[90msrc/components/game/CombatTracker.tsx[39m 15ms (unchanged)
...
[90msrc/components/game/TradeModal.tsx[39m 34ms (unchanged)
...
[90msrc/hooks/useGameState.ts[39m 81ms (unchanged)
...
[90msrc/lib/__tests__/imageProcessor.test.ts[39m 23ms (unchanged)
...
[90mtests/e2e/reporting/html-reporter.ts[39m 37ms (unchanged)
...
[90mtests/e2e/visual/visual-audit.spec.ts[39m 7ms (unchanged)
[90mtests/integration/mobile-animations.test.ts[39m 22ms (unchanged)
...
[32m✓ built in 10.71s[39m

[36mPWA v1.1.0[39m
mode      [35mgenerateSW[39m
precache  [32m66 entries[39m [2m(2658.79 KiB)[22m
files generated
