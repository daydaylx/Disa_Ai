...
[90mDEPENDENCIES_UPDATE_STRATEGY.md[39m 31ms (unchanged)
[90mdeploy/cloudflare/cloudflare-pages.json[39m 3ms (unchanged)
DESIGN_SYSTEM_AUDIT.md 212ms
[90mDESIGN_SYSTEM_FIXES.md[39m 36ms (unchanged)
[90mDESIGN_SYSTEM_KEY_FINDINGS.md[39m 42ms (unchanged)
[90mDESIGN_SYSTEM_README.md[39m 33ms (unchanged)
[90mDESIGN_SYSTEM_SUMMARY.md[39m 20ms (unchanged)
...
[90mpublic/models.json[39m 6ms (unchanged)
...
[90mREADME.md[39m 85ms (unchanged)
[90mrenovate.json[39m 5ms (unchanged)
[90mreport/html/index.html[39m 47ms (unchanged)
[90mreport/html/jscpd-report.json[39m 99ms (unchanged)
...
[90msrc/app/router.tsx[39m 24ms (unchanged)
...
[90msrc/components/dev/FeatureFlagPanel.tsx[39m 21ms (unchanged)
[90msrc/components/ErrorBoundary.tsx[39m 31ms (unchanged)
[90msrc/components/layout/Header.tsx[39m 4ms (unchanged)
...
[90msrc/components/StorageMigration.tsx[39m 21ms (unchanged)
...
[90msrc/components/ui/chip/README.md[39m 27ms (unchanged)
...
[90msrc/components/ui/input.tsx[39m 5ms (unchanged)
[90msrc/components/ui/label.tsx[39m 2ms (unchanged)
[90msrc/components/ui/ModelCard.tsx[39m 17ms (unchanged)
[90msrc/components/ui/README.md[39m 15ms (unchanged)
...
[90msrc/components/ui/Switch.tsx[39m 6ms (unchanged)
[90msrc/components/ui/table.tsx[39m 7ms (unchanged)
[90msrc/components/ui/tabs.tsx[39m 7ms (unchanged)
...
[90msrc/data/roles.dataset.ts[39m 17ms (unchanged)
...
[90msrc/features/settings/SettingsOverview.tsx[39m 21ms (unchanged)
...
[90msrc/lib/mobile-testing-plan.md[39m 18ms (unchanged)
[90msrc/lib/monitoring/README.md[39m 9ms (unchanged)
...
[90msrc/lib/storage-migration.ts[39m 15ms (unchanged)
...
[90msrc/lib/touch/gestures.ts[39m 25ms (unchanged)
...
[90mSTORAGE_MIGRATION_GUIDE.md[39m 44ms (unchanged)
[90mtailwind.config.ts[39m 12ms (unchanged)
[90mtest_deferred_loading.md[39m 25ms (unchanged)
[90mtest_edge_swipe.md[39m 18ms (unchanged)
[90mtest_lazy_highlighter.md[39m 9ms (unchanged)
[90mtest_network_timeline.md[39m 12ms (unchanged)
[90mtests/e2e/api-mock.ts[39m 6ms (unchanged)
[90mtests/e2e/chat-flow.spec.ts[39m 12ms (unchanged)
...
[90mtests/unit/lib/storage-migration.test.ts[39m 46ms (unchanged)
...
[90mtmp/shadow-performance-test.html[39m 17ms (unchanged)
...
/home/runner/work/Disa_Ai/Disa_Ai/src/lib/icons/index.ts: AlertTriangle, ArrowLeft, Book, Brain, Clock, Code, History, Menu, MessageCircle, MessageSquare, Pin, PinOff, Plus, Tag, ThumbsDown, ThumbsUp, Trash2
...
transforming...
[32m✓[39m 3281 modules transformed.
rendering chunks...
...
[2mdist/[22m[32mindex.html                                             [39m[1m[2m  5.32 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[35mcss/index-DoeJ08u1.css                          [39m[1m[2m  8.05 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[35mcss/index-uVwECKsV.css                          [39m[1m[2m 12.02 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/SettingsApi-BwnYRBXn.js                      [39m[1m[2m  0.59 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsData-BCPSVoyQ.js                     [39m[1m[2m  0.59 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsMemory-CdfgC1mA.js                   [39m[1m[2m  0.59 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsFilters-C9qFzXer.js                  [39m[1m[2m  0.59 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsAppearance-Deq_NG-V.js               [39m[1m[2m  0.60 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/useFeatureFlags-_HGl5_uc.js                  [39m[1m[2m  0.85 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/key-C3rcisgd.js                              [39m[1m[2m  0.93 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/MobileStudio-fJb59GLI.js                     [39m[1m[2m  1.22 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/MobileModels-ezSy5BCA.js                     [39m[1m[2m  1.29 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/input-Ckf6YLZz.js                            [39m[1m[2m  1.48 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/avatar-CC9u-0oX.js                           [39m[1m[2m  1.53 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/badge-Q9UXiWHY.js                            [39m[1m[2m  3.75 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/FeatureFlagPanel-97sncmFP.js                 [39m[1m[2m  3.85 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsOverviewPage-CyJvhrFL.js             [39m[1m[2m  6.79 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/conversation-manager-modern-B8Gei8e_.js      [39m[1m[2m  8.56 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/modelDescriptions-DYsQFogR.js                [39m[1m[2m  9.62 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/SettingsView-BD2axxIC.js                     [39m[1m[2m 15.13 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/EnhancedRolesInterface-BDi5J_qr.js           [39m[1m[2m 15.49 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/EnhancedModelsInterface-DiEGm0KN.js          [39m[1m[2m 24.23 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/StatusCard-BfZqVHjg.js                       [39m[1m[2m 24.82 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/Chat-GxUZYrKw.js                             [39m[1m[2m 35.76 kB[22m[1m[22m
...
[2mdist/[22m[2massets/[22m[36mjs/radix-ui-DxtOQftI.js                         [39m[1m[2m 75.24 kB[22m[1m[22m
[2mdist/[22m[2massets/[22m[36mjs/index-CLGpYs97.js                            [39m[1m[2m 91.18 kB[22m[1m[22m
...
[2m[1m95[2m[22m chunks of [2m[1m2.03 MB[2m[22m (gzip: [2m[1m1.21 MB[2m[22m | map: [2m[1m4.34 MB[2m[22m)
[32m✓ built in 10.57s[39m

[36mPWA v1.1.0[39m
mode      [35mgenerateSW[39m
precache  [32m56 entries[39m [2m(1563.40 KiB)[22m
files generated
