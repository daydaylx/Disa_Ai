...
Running Prettier...
npm warn config production Use `--omit=dev` instead.
[90m.changeset/config.json[39m 30ms (unchanged)
...
[90mPROXY_SECURITY_SUMMARY.md[39m 60ms (unchanged)
...
[90msrc/styles/page-spacing.css[39m 21ms (unchanged)
...
precache  [32m72 entries[39m [2m(2415.55 KiB)[22m
files generated
