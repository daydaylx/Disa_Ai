...
[90mREADME.md[39m 52ms (unchanged)
...
[90mscripts/check-lighthouse-budget.mjs[39m 21ms (unchanged)
...
[90msrc/__tests__/message-id-synchronization.test.ts[39m 31ms (unchanged)
...
[90msrc/components/chat/UnifiedInputBar.tsx[39m 30ms (unchanged)
...
[90msrc/ui/SettingsRow.tsx[39m 9ms (unchanged)
...
[90mtests/unit/proxy-security.test.ts[39m 21ms (unchanged)
...
[90mvite.config.ts[39m 19ms (unchanged)
