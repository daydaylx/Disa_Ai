...
[90mindex.html[39m 174ms (unchanged)
...
[90mPR_BODY.md[39m 20ms (unchanged)
...
[90msrc/api/__tests__/visionClient.test.ts[39m 26ms (unchanged)
...
[90msrc/components/chat/ContextTray.tsx[39m 42ms (unchanged)
...
[90msrc/components/game/TradeModal.tsx[39m 23ms (unchanged)
...
[90msrc/hooks/__tests__/useGameState.test.ts[39m 22ms (unchanged)
...
[90msrc/hooks/useImageAttachment.ts[39m 9ms (unchanged)
...
[90msrc/lib/__tests__/imageProcessor.test.ts[39m 14ms (unchanged)
...
[90msrc/ui/PremiumCard.tsx[39m 8ms (unchanged)
...
[90mVISION_ANALYSIS_REPORT.md[39m 71ms (unchanged)
...
precache  [32m66 entries[39m [2m(2658.16 KiB)[22m
files generated
