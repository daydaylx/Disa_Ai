...
[90mCLAUDE.md[39m 84ms (unchanged)
...
[90mPRIVACY.md[39m 34ms (unchanged)
public/clear-cache.html 28ms
...
[90msrc/components/chat/__tests__/AnimatedCoreBackground.test.tsx[39m 5ms (unchanged)
...
[90msrc/components/chat/ChatSettingsDropup.tsx[39m 22ms (unchanged)
...
[90msrc/components/navigation/Breadcrumbs.tsx[39m 18ms (unchanged)
...
[90msrc/components/navigation/MobileBackButton.tsx[39m 16ms (unchanged)
...
[90msrc/config/orbPresets.ts[39m 5ms (unchanged)
...
[90msrc/features/settings/SettingsBehaviorView.tsx[39m 7ms (unchanged)
...
[90msrc/lib/analytics.test.ts[39m 19ms (unchanged)
...
src/styles/animated-core.css 10ms
...
[90msrc/types/orb.ts[39m 2ms (unchanged)
...
precache  [32m65 entries[39m [2m(3258.55 KiB)[22m
files generated
