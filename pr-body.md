...
[90mCACHE_FIX_ANLEITUNG.md[39m 56ms (unchanged)
[90mCHANGELOG.md[39m 12ms (unchanged)
[90mCHAT_AUDIT_REPORT.md[39m 133ms (unchanged)
...
[90mFIX_1_IMPLEMENTATION.md[39m 61ms (unchanged)
...
[90mpublic/datenschutz.html[39m 64ms (unchanged)
...
[90msrc/__tests__/lib/storage-schema-migration.test.ts[39m 38ms (unchanged)
...
[90msrc/components/chat/context/__tests__/ContextBar.test.tsx[39m 10ms (unchanged)
[90msrc/components/chat/context/ContextAction.tsx[39m 3ms (unchanged)
[90msrc/components/chat/context/ContextBar.tsx[39m 8ms (unchanged)
[90msrc/components/chat/context/OverflowSheet.tsx[39m 20ms (unchanged)
[90msrc/components/chat/UnifiedInputBar.tsx[39m 9ms (unchanged)
...
[90msrc/components/navigation/AchievementSystem.tsx[39m 18ms (unchanged)
...
[90msrc/hooks/useConversationManager.ts[39m 39ms (unchanged)
...
[90msrc/lib/accessibility.ts[39m 25ms (unchanged)
...
[90msrc/lib/storage-schema-migration.ts[39m 20ms (unchanged)
...
[90msrc/pages/ThemenPage.tsx[39m 6ms (unchanged)
...
[90msrc/ui/DropdownMenu.tsx[39m 7ms (unchanged)
...
[90msrc/ui/NotchFrame.tsx[39m 7ms (unchanged)
...
[90mtests/integration/mobile-animations.test.ts[39m 23ms (unchanged)
...
[90mtests/setup.ts[39m 13ms (unchanged)
