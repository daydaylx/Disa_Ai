...
var _self =
  ...
  Prism = (function (e) {
          ...
          insertBefore: function (e, t, a, n) {
            ...
            for (var l in s)
              if (s.hasOwnProperty(l)) {
                if (l == t) for (var o in a) a.hasOwnProperty(o) && (i[o] = a[o]);
            ...
            for (
              ...
              if (!(P instanceof s)) {
                ...
                if (b) {
                  ...
                  if (((w = _ -= x.value.length), x.value instanceof s)) continue;
                  for (var j = x; j !== t.tail && (_ < E || "string" == typeof j.value); j = j.next)
                    ($++, (_ += j.value.length));
    ...
    if (
      (g && ((r.filename = g.src), g.hasAttribute("data-manual") && (r.manual = !0)), !r.manual)
    ) {
