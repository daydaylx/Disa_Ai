                ...
                <div className="prose max-w-none">
                  ...
                  <section className="mb-6">
                    ...
                    <p>
                      ...
                      Daten können jedoch durch die verwendeten Dienstleister automatisch
                      verarbeitet werden, um die Seite bereitzustellen und den Betrieb
                      sicherzustellen.
                    </p>
                  </section>
                  ...
                  <section className="mb-6">
                    ...
                    <p className="mb-2">
                      ...
                      verarbeitet technische Daten im Rahmen der Domainverwaltung, z. B.
                      DNS-Einträge, Serververbindungen und administrative Kontaktinformationen.
                    </p>
                    <p className="mb-2">
                      <strong>Zweck:</strong> Registrierung, Verwaltung und Bereitstellung der
                      Domain.
                    </p>
                    <p className="mb-4">
                  ...
                  <section className="mb-6">
                    ...
                    <p>
                      ...
                      Sicherheit der Datenübertragung im Internet kann jedoch nicht garantiert
                      werden.
                    </p>
                  </section>
