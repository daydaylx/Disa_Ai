...
type Size = "sm" | "md" | "lg";
const base =
  "inline-flex items-center justify-center gap-2 rounded-2xl font-semibold focus-ring transition-transform active:scale-[0.98] disabled:opacity-50 disabled:cursor-not-allowed";
...
export function Button({
  ...
  return (
    <button className={cn(base, map[variant], sizes[size], className)} {...rest}>
      {children}
    </button>
  );
}
