...
export default function CodeBlock({ code, lang, onCopied, className }: CodeBlockProps) {
  ...
  return (
    <div
      className={cn(
        "border-border bg-surface-2 text-text-0 relative overflow-hidden rounded-base border text-sm",
        className,
      )}
    >
      ...
      <div className="border-border bg-surface-1 flex items-center justify-between border-b px-4 py-2 pl-6">
        ...
        <div className="flex items-center gap-1">
          <button
            ...
            className={cn(
              "text-text-1 hover:bg-surface-2 hover:text-text-0 focus-visible:ring-brand focus-visible:ring-offset-surface-1 inline-flex h-9 w-9 items-center justify-center rounded-base border border-transparent transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2",
