...
export default function Icon({ name, ...rest }: Props) {
  ...
  if (name === "settings")
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...rest}>
        ...
        <path
          d="M19.4 15a1.65 1.65 0 0 0 .33 1.82l.06.06a2 2 0 1 1-2.83 2.83l-.06-.06a1.65 1.65 0 0 0-1.82-.33 1.65 1.65 0 0 0-1 1.51V21a2 2 0 1 1-4 0v-.09a1.65 1.65 0 0 0-1-1.51 1.65 1.65 0 0 0-1.82.33l-.06.06a2 2 0 1 1-2.83-2.83l.06-.06a1.65 1.65 0 0 0 .33-1.82 1.65 1.65 0 0 0-1.51-1H3a2 2 0 1 1 0-4h.09a1.65 1.65 0 0 0 1.51-1 1.65 1.65 0 0 0-.33-1.82l-.06-.06a2 2 0 1 1 2.83-2.83l.06.06A1.65 1.65 0 0 0 8.12 4a1.65 1.65 0 0 0 1-1.51V3a2 2 0 1 1 4 0v.09a1.65 1.65 0 0 0 1 1.51 1.65 1.65 0 0 0 1.82-.33l.06-.06a2 2 0 1 1 2.83 2.83l-.06.06a1.65 1.65 0 0 0-.33 1.82c.12.57.53 1.04 1.1 1.2H21a2 2 0 1 1 0 4h-.09c-.57.16-.98.63-1.1 1.2z"
          strokeWidth="1.5"
        />
      </svg>
    );
  if (name === "sparkles")
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...rest}>
        <path
          d="M5 3l1.5 3L10 7.5 6.5 9 5 12 3.5 9 0 7.5 3.5 6 5 3z"
          transform="translate(2 2)"
          strokeWidth="1.5"
          fill="currentColor"
        />
        <path
          d="M18 2l.8 1.6L21 4.5 18.8 5.4 18 7 17.2 5.4 15 4.5l2.2-.9L18 2z"
          strokeWidth="1.5"
          fill="currentColor"
        />
      </svg>
  ...
  if (name === "key")
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...rest}>
        ...
        <path d="M10 7h11l-3 3 3 3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    );
  if (name === "shield")
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...rest}>
        <path d="M12 2l7 4v6a9 9 0 0 1-7 8 9 9 0 0 1-7-8V6l7-4z" strokeWidth="2" />
      </svg>
    );
  if (name === "role")
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...rest}>
        ...
        <path d="M2 22a6 6 0 0 1 12 0" strokeWidth="2" />
        <rect x="14" y="4" width="8" height="6" rx="1.5" strokeWidth="2" />
      </svg>
    );
  if (name === "style")
    return (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" {...rest}>
        ...
        <path d="M10 8h4v4h-4z" strokeWidth="2" />
      </svg>
    );
  if (name === "nsfw")
    return (
