  ...
  if (canPrompt) {
    return (
      <div className="px-3 pt-2">
        ...
        >
          Installiere die App für Schnellstart, Taskleisten-Icon und stabileres Verhalten.
        </InlineBanner>
      </div>
    )
  }
    ...
    return (
      <div className="px-3 pt-2">
        <InlineBanner
          ...
          actions={<button onClick={dismiss} className="underline opacity-80">Ok</button>}
        >
          iPhone/iPad: Tippe auf <strong>Teilen</strong> <span aria-hidden>▵</span> → <strong>Zum Home-Bildschirm</strong>.
        </InlineBanner>
      </div>
    )
  }
