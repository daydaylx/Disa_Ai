...
const items: TemplateLite[] = Array.isArray(list)
? (list as unknown as TemplateLite[])
: [];
...
<h3 className="text-lg font-semibold text-neutral-100 mb-2">Schnellzugriff: Stile</h3>
