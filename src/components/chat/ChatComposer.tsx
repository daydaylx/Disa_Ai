  ...
  return (
    ...
    >
      <div className="mx-auto max-w-md space-y-3 text-text-secondary">
        ...
        <div
          className={cn(
            "flex items-end gap-2 rounded-[var(--radius-xl)] border border-[color-mix(in_srgb,var(--color-border-focus)_30%,transparent)] bg-[var(--surface-neumorphic-floating)] p-2 shadow-[var(--shadow-inset-subtle)] backdrop-blur-sm glass-panel",
