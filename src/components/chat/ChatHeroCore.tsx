...
const ORB_CORE_CONFIG: Record<CoreStatus, OrbLayerConfig> = {
  idle: {
    coreGradient: "from-indigo-500 via-violet-500 to-blue-500",
    irisGradient: "from-slate-950 via-indigo-900 to-slate-800",
    rimGradient: "from-indigo-200/80 via-violet-200/75 to-blue-200/75",
    glowColor: "bg-indigo-500/26",
    ringColor: "border-indigo-200/50",
    particleColor: "bg-indigo-100/85",
    segmentColor: "bg-violet-200/80",
    highlightColor: "bg-indigo-50/80",
    scanlineColor: "rgba(232, 236, 255, 0.14)",
    waveColor: "rgba(122, 178, 255, 0.32)",
    irisDuration: 36,
    segmentDuration: 18,
    scanlineDuration: 12,
    glareDuration: 10,
  ...
  thinking: {
    coreGradient: "from-fuchsia-500 via-violet-500 to-indigo-500",
    irisGradient: "from-slate-950 via-fuchsia-900 to-slate-800",
    rimGradient: "from-fuchsia-200/85 via-violet-200/80 to-indigo-200/80",
    glowColor: "bg-fuchsia-500/32",
    ringColor: "border-fuchsia-200/55",
    particleColor: "bg-fuchsia-100/90",
    segmentColor: "bg-violet-200/90",
    highlightColor: "bg-white/88",
    scanlineColor: "rgba(240, 234, 255, 0.18)",
    waveColor: "rgba(209, 134, 255, 0.36)",
    irisDuration: 18,
    segmentDuration: 10,
    scanlineDuration: 8,
    glareDuration: 8,
  ...
  streaming: {
    coreGradient: "from-indigo-400 via-sky-500 to-fuchsia-500",
    irisGradient: "from-slate-950 via-indigo-900 to-slate-800",
    rimGradient: "from-indigo-200/90 via-sky-200/90 to-fuchsia-200/85",
    glowColor: "bg-sky-500/36",
    ringColor: "border-indigo-200/70",
    particleColor: "bg-sky-100/95",
    segmentColor: "bg-indigo-100/95",
    highlightColor: "bg-white/92",
    scanlineColor: "rgba(236, 242, 255, 0.2)",
    waveColor: "rgba(134, 198, 255, 0.42)",
    irisDuration: 12,
    segmentDuration: 6,
    scanlineDuration: 6,
    glareDuration: 6,
  ...
  error: {
    ...
    scanlineColor: "rgba(255, 245, 240, 0.2)",
