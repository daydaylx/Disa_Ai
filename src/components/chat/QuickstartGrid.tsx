...
import { Brain, Code2, PenSquare } from "../../lib/icons";
          ...
          return (
            ...
            >
              <div className="flex items-center gap-2">
                <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-[var(--accent-soft)] text-[var(--accent)] shadow-[0_12px_35px_rgba(97,231,255,0.25)]">
                  <Icon className="h-4 w-4" />
                </span>
                <CardTitle className="text-base font-semibold">{quickstart.title}</CardTitle>
              </div>
