      ...
      {startTiles.map((tile) => {
        ...
        return (
          <button
            ...
            className={cn(
              "card-depth group relative flex h-full flex-col gap-2.5 overflow-hidden rounded-base border border-border bg-surface-1 p-3 text-left transition-all duration-150",
