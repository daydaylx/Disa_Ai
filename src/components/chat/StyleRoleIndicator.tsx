...
export function StyleRoleIndicator({ onQuickStylesClick, className }: StyleRoleIndicatorProps) {
  ...
  return (
    <GlassCard
      variant="subtle"
      className={`hover:bg-white/10 inline-flex cursor-pointer items-center gap-2 px-3 py-2 transition-colors ${className}`}
