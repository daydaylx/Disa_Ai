...
export interface UnifiedInputBarHandle {
  ...
  (
    ...
    const discussionPresetLabel =
      settings.discussionPreset && shortDiscussionLabels[settings.discussionPreset]
        ...
        : discussionPresetOptions.find((preset) => preset.key === settings.discussionPreset)
            ?.label || "Standard";
    ...
    React.useImperativeHandle(
      ref,
      () => ({
        insertRandomPrompt: handleInsertRandomPrompt,
      }),
          ...
          <div className="flex items-end gap-3 px-4 pt-3 pb-2 pr-safe-right">
            ...
            <Button
              ...
              className={cn(
                ...
                !value.trim() &&
                  !isLoading &&
                  "bg-white/5 text-ink-muted/30 shadow-none opacity-40",
                value.trim() &&
                  !isLoading &&
...
UnifiedInputBar.displayName = "UnifiedInputBar";
