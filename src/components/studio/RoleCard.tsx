  ...
  (
    ...
    return (
      <div
        ...
        className={cn(
          "flex min-h-[108px] flex-col p-5 text-left text-white transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/35 sm:p-6",
        ...
        <div className="relative z-10 flex h-full flex-col">
          <div className="flex items-start justify-between gap-4">
            <div className="flex-1">
              ...
              {expanded ? (
                <p className="mt-2 line-clamp-3 text-sm leading-6 text-white/90 [text-shadow:0_0_8px_rgba(6,10,24,0.35)] sm:text-base sm:leading-7">
                  {description}
                </p>
              ) : null}
            </div>
            <div className="flex shrink-0 items-center gap-2">
              ...
              {showDescriptionOnToggle ? (
                <button
                  ...
                  className="bg-white/12 hover:bg-white/16 inline-flex h-8 w-8 items-center justify-center rounded-full border border-white/15 text-white/80 transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
