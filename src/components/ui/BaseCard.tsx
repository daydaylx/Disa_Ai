...
const BaseCard = React.forwardRef<HTMLDivElement, BaseCardProps>(
  ({ 
    ...
    const variantClasses = {
      ...
      elevated: "border border-border-subtle bg-surface-raised text-text-primary shadow-[var(--shadow-card)]",
      glass: "border border-[var(--glass-border-soft)] bg-[var(--layer-glass-panel)] text-text-primary shadow-[var(--shadow-card)] backdrop-blur-[var(--glass-backdrop-blur-sm)]",
    };
