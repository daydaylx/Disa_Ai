...
type Variant = "solid" | "ghost" | "subtle" | "danger" | "destructive" | "accent";
...
const variants: Record<Variant, string> = {
  ...
  destructive: "bg-[hsl(350_84%_56%_/_1)] text-white hover:opacity-90",
  accent: "bg-[color:var(--accent)] text-black hover:opacity-90",
};
