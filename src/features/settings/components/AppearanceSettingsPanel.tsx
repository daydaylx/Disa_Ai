...
export function AppearanceSettingsPanel({
  ...
  return (
    <div className="p-4 sm:p-6 space-y-6 bg-transparent animate-in slide-in-from-top-2 duration-200">
      {/* Theme */}
      <div className="space-y-3">
        <Label className="text-sm font-medium text-ink-primary">Design-Modus</Label>
        <div className="flex p-1 rounded-lg bg-surface-2/50 border border-white/[0.08]">
      ...
      {/* Font Size */}
      <div className="space-y-3">
        <Label htmlFor="appearance-font-size" className="text-sm font-medium text-ink-primary">
        ...
        <input
          ...
          className="w-full accent-accent-settings h-11 rounded-full bg-surface-2/50 cursor-pointer"
        />
      ...
      <div className="space-y-4 pt-2">
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-sm text-ink-primary">OLED Dark Mode</span>
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-ink-primary">Animationen reduzieren</span>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col">
            <span className="text-sm text-ink-primary">Batteriesparmodus</span>
            <span className="text-xs text-ink-muted">Reduziert Animationen & Effekte</span>
          </div>
          <Switch
        ...
        <div className="flex items-center justify-between">
          <span className="text-sm text-ink-primary">Haptisches Feedback</span>
          <Switch
