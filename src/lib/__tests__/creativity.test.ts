...
describe("mapCreativityToParams", () => {
  it("maps 0 to lowest bounds", () => {
    const res = mapCreativityToParams(0, DEFAULT_MODEL_ID);
  ...
  it("maps 20 to first breakpoint", () => {
    const res = mapCreativityToParams(20, DEFAULT_MODEL_ID);
  ...
  it("maps 60 to second breakpoint", () => {
    const res = mapCreativityToParams(60, DEFAULT_MODEL_ID);
  ...
  it("maps 100 to upper caps", () => {
    const res = mapCreativityToParams(100, DEFAULT_MODEL_ID);
