          ...
          <Card className="w-full max-w-3xl mb-8" padding="lg">
            <div className="space-y-8">
              <div className="text-center pb-4 border-b border-white/5">
                ...
                <p className="text-sm text-ink-secondary mt-2">Informationen über die Verarbeitung personenbezogener Daten</p>
              </div>
              ...
              <section className="space-y-3">
                ...
                <div className="text-ink-secondary space-y-2 text-sm">
                  <p>
                    David Grunert<br />
                    E-Mail: <a href="mailto:grunert94@hotmail.com" className="text-accent-primary hover:underline">grunert94@hotmail.com</a>
                  </p>
                  <p>
              ...
              <section className="space-y-6">
                ...
                <div className="space-y-2 text-sm">
                  <h3 className="font-medium text-ink-primary">a) INWX GmbH & Co. KG (Domain-Provider)</h3>
                ...
                {/* Cloudflare */}
                <div className="space-y-2 text-sm">
                  <h3 className="font-medium text-ink-primary">b) Cloudflare Inc. (Content Delivery / Sicherheitsdienst)</h3>
                  <div className="text-ink-secondary space-y-2">
                    <p>
                      Zur Bereitstellung, Absicherung und Beschleunigung der Website wird der Dienst
                      Cloudflare Inc., USA, eingesetzt. Cloudflare verarbeitet technische Informationen wie IP-Adresse, Browsertyp, Datum,
                ...
                <div className="space-y-2 text-sm">
                  ...
                  <div className="text-ink-secondary space-y-2">
                    ...
                    <p>
                      Ich selbst speichere keine Eingaben oder Antworten dauerhaft auf meinen Servern (Verlauf nur lokal im Browser).
                    </p>
                  </div>
                </div>
              </section>
