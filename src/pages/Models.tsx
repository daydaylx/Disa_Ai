        ...
        >
          {isSelected && (
            <div className="flex justify-end">
              <span className="glass-card-tertiary rounded-full px-2 py-0.5 text-xs font-medium text-white">
                ✓ Aktiv
              </span>
            </div>
          )}
    ...
    <div className="flex h-full flex-col px-5 pb-8 pt-5">
      ...
      >
        <div className="flex items-center justify-end">
          <Link
            to="/roles"
            className="glass-card-secondary inline-flex items-center justify-center rounded-full px-4 py-2 text-xs font-semibold text-white transition hover:bg-white/15 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/40"
          >
            Rollen öffnen
          </Link>
        </div>
