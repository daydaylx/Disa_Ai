    ...
    <div className="mx-auto flex h-full w-full max-w-md flex-col gap-4 p-4">
      ...
      <StaticGlassCard tint={palette[0] ?? DEFAULT_TINT} padding="lg">
        ...
        <div className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              <Input
                ...
                placeholder="sk-or-..."
                className="glass-input pr-10 font-mono text-corporate-text-primary placeholder:text-corporate-text-muted"
              />
              <button
                type="button"
                onClick={() => setShowKey(!showKey)}
                aria-label={showKey ? "API-Schlüssel ausblenden" : "API-Schlüssel anzeigen"}
                className="glass-button absolute right-2 top-1/2 grid min-h-touch-rec min-w-touch-rec -translate-y-1/2 place-items-center rounded-full text-corporate-text-secondary transition hover:text-corporate-text-primary focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent-400"
              >
          ...
          <Button
            ...
            className="glass-button text-corporate-text-onSurface min-h-touch-rec w-full border-0"
          >
            Schlüssel speichern
          </Button>
      ...
      <StaticGlassCard tint={palette[4] ?? DEFAULT_TINT} padding="lg">
        ...
        <div className="space-y-4">
          ...
          {!isInstalled && (
            <div className="glass-ultra-transparent rounded-lg p-3">
      ...
      <StaticGlassCard tint={palette[5] ?? DEFAULT_TINT} padding="lg">
        ...
        <div className="space-y-4">
          ...
          <div className="glass-ultra-transparent rounded p-3 text-xs">
