  ...
  return (
    <div className="flex h-full flex-col px-5 pb-8 pt-5">
      <header className="mb-6 space-y-5">
        <div>
          <h2 className="text-balance text-xl font-semibold text-text-0 sm:text-2xl">
            Rollen-Studio
          </h2>
        ...
        {activeRole ? (
          <div className="flex items-start justify-between gap-4 rounded-lg border border-border bg-surface-1 px-5 py-4 text-xs text-text-1">
            ...
            return (
              <section key={category} className="space-y-4 sm:space-y-5">
                <div className="flex items-center justify-between gap-3">
                  <h3 className="text-balance text-sm font-semibold text-text-1 sm:text-base">
                    {category}
...
function GamesTab() {
  ...
  return (
    <div className="flex h-full flex-col gap-7 px-5 pb-8 pt-5 text-text-0">
      <div>
        <h2 className="text-balance text-xl font-semibold text-text-0 sm:text-2xl">Spiele</h2>
        <p className="mt-1 text-pretty text-sm leading-7 text-text-1 sm:text-base">
      ...
      <div className="grid grid-cols-1 gap-3.5 sm:grid-cols-2">
        {games.map((game) => (
          <div
            key={game.id}
            className="flex min-h-[120px] cursor-pointer flex-col gap-3 rounded-lg border border-border bg-surface-1 p-4 transition-all duration-200 hover:border-brand sm:p-5"
