...
export function buildSystemFromSettings(opts: { nsfw: boolean; style: StyleKey; roleTemplateId?: string | null; locale?: "de-DE" | "de"; memory?: string | null }): string {
  ...
  return [role, base, mem].filter(Boolean).join("\n\n")
}

export function buildMessages(args: { userInput: string; history?: OpenRouterMessage[]; nsfw: boolean; style: StyleKey; roleTemplateId?: string | null; locale?: "de-DE" | "de"; memory?: string | null }): OpenRouterMessage[] {
