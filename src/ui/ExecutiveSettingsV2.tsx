...
function ExecutiveSettingsPanel() {
  ...
  return (
    <div className="flex h-full flex-col bg-slate-950">
      {/* Executive Header */}
      <header
        className="border-b border-slate-800 bg-slate-950/95 backdrop-blur-xl"
        data-testid="executive-settings-header"
      >
        ...
        <div className="mx-auto max-w-6xl space-y-6">
          {settingsCategories.map((category, i) => (
            <div
              ...
              data-testid={`settings-category-${category.title.toLowerCase().replace(/\s+/g, "-")}`}
            >
