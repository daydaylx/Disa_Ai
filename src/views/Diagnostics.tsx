...
export default function Diagnostics() {
  ...
  return (
    <div className="bg-black text-white min-h-[100svh] p-6">
      <h1 className="mb-2 text-2xl font-semibold">Projekt-Diagnose</h1>
      ...
      {r.count > 0 ? (
        ...
        <p className="mt-4">
          Keine offensichtliche Korruption erkannt. Dann liegt der Fehler woanders.
        </p>
      )}
    </div>
  );
