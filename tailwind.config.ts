  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        "orb-arc-flicker": "orbArcFlicker 5s ease-in-out infinite",
      ...
      keyframes: {
        ...
        orbArcFlicker: {
          "0%, 100%": { opacity: "0.35", transform: "scale(0.98) rotate(-1deg)" },
          "35%": { opacity: "0.9", transform: "scale(1.03) rotate(1deg)" },
          "70%": { opacity: "0.55", transform: "scale(1) rotate(-0.5deg)" },
        },
        "pulse-subtle": {
          "0%, 100%": { opacity: "0.4" },
          "50%": { opacity: "0.5" },
