// Unit tests for modern storage layer
import { describe, it, expect, beforeEach, vi } from 'vitest';
import Dexie from 'dexie';
import { ModernStorageLayer, type Conversation, type ConversationMetadata } from '@/lib/storage-layer';
...
describe('ModernStorageLayer', () => {
  ...
  describe('getAllConversations', () => {
    it('should return conversations sorted by updatedAt descending', async () => {
      ...
      mockDb.metadata.orderBy.mockReturnValue({
  ...
  describe('saveConversation', () => {
    ...
    it('should throw error when save fails', async () => {
      ...
      await expect(storage.saveConversation(conversation))
  ...
  describe('deleteConversation', () => {
    ...
    it('should throw error when delete fails', async () => {
      ...
      await expect(storage.deleteConversation('1'))
  ...
  describe('importConversations', () => {
    it('should import conversations successfully', async () => {
      ...
      const result = await storage.importConversations(importData, { overwrite: false, merge: false });
  ...
  describe('clearAllData', () => {
    ...
    it('should throw error when clear fails', async () => {
      ...
      await expect(storage.clearAllData())
